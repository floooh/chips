...
void ui_z80_init(ui_z80_t* win, ui_z80_desc_t* desc);
void ui_z80_discard(ui_z80_t* win);
void ui_z80_open(ui_z80_t* win);
void ui_z80_close(ui_z80_t* win);
void ui_z80_toggle(ui_z80_t* win);
bool ui_z80_isopen(ui_z80_t* win);
