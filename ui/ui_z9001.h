...
static void _ui_z9001_draw_menu(ui_z9001_t* ui) {
...
void ui_z9001_init(ui_z9001_t* ui, const ui_z9001_desc_t* ui_desc) {
    ...
    x += dx; y += dy;
    {
        ...
        desc.sample_buffer = ui->z9001->audio.sample_buffer;
        desc.num_samples = ui->z9001->audio.num_samples;
        desc.x = x;
        desc.y = y;
...
void ui_z9001_save_settings(ui_z9001_t* ui, ui_settings_t* settings) {
    ...
    for (int i = 0; i < 2; i++) {
        ui_z80pio_save_settings(&ui->pio[i], settings);
    }
...
void ui_z9001_load_settings(ui_z9001_t* ui, const ui_settings_t* settings) {
    ...
    for (int i = 0; i < 2; i++) {
        ui_z80pio_load_settings(&ui->pio[i], settings);
    }
