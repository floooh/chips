...
static void _ui_m6522_draw_state(ui_m6522_t* win) {
    ...
    ImGui::Text("%02X", via->ddr_a); ImGui::NextColumn();
    ImGui::Text("%02X", via->ddr_b); ImGui::NextColumn();
    ImGui::Text("Out"); ImGui::NextColumn();
    ImGui::Text("%02X", via->out_a); ImGui::NextColumn();
    ImGui::Text("%02X", via->out_b); ImGui::NextColumn();
    ImGui::Text("In"); ImGui::NextColumn();
    ImGui::Text("%02X", via->in_a); ImGui::NextColumn();
    ImGui::Text("%02X", via->in_b); ImGui::NextColumn();
    ImGui::Text("Port"); ImGui::NextColumn();
    ImGui::Text("%02X", via->port_a); ImGui::NextColumn();
    ImGui::Text("%02X", via->port_b); ImGui::NextColumn();
    ImGui::Separator();
    ImGui::NextColumn();
    ImGui::Text("T1"); ImGui::NextColumn();
    ImGui::Text("T2"); ImGui::NextColumn();
    ImGui::Separator();
