...
uint32_t m6502_exec(m6502_t* cpu, uint32_t num_ticks) {
  ...
  do {
    ...
    switch (opcode) {
      ...
      case 0x26:/*ROL zp*/_A_ZER();_RD();l=_GD();_WR();{bool carry=c.P&M6502_CF;c.P&=~(M6502_NF|M6502_ZF|M6502_CF);if(l&0x80){c.P|=M6502_CF;}l<<=1;if(carry){l|=0x01;}_NZ(l);}_SD(l);_WR();break;
      ...
      case 0x2e:/*ROL abs*/_A_ABS();_RD();l=_GD();_WR();{bool carry=c.P&M6502_CF;c.P&=~(M6502_NF|M6502_ZF|M6502_CF);if(l&0x80){c.P|=M6502_CF;}l<<=1;if(carry){l|=0x01;}_NZ(l);}_SD(l);_WR();break;
      ...
      case 0x36:/*ROL zp,X*/_A_ZPX();_RD();l=_GD();_WR();{bool carry=c.P&M6502_CF;c.P&=~(M6502_NF|M6502_ZF|M6502_CF);if(l&0x80){c.P|=M6502_CF;}l<<=1;if(carry){l|=0x01;}_NZ(l);}_SD(l);_WR();break;
      ...
      case 0x3e:/*ROL abs,X*/_A_ABX_W();_RD();l=_GD();_WR();{bool carry=c.P&M6502_CF;c.P&=~(M6502_NF|M6502_ZF|M6502_CF);if(l&0x80){c.P|=M6502_CF;}l<<=1;if(carry){l|=0x01;}_NZ(l);}_SD(l);_WR();break;
      ...
      case 0x46:/*LSR zp*/_A_ZER();_RD();l=_GD();_WR();c.P=(c.P&~M6502_CF)|((l&0x01)?M6502_CF:0);l>>=1;_NZ(l);_SD(l);_WR();break;
      ...
      case 0x4e:/*LSR abs*/_A_ABS();_RD();l=_GD();_WR();c.P=(c.P&~M6502_CF)|((l&0x01)?M6502_CF:0);l>>=1;_NZ(l);_SD(l);_WR();break;
      ...
      case 0x56:/*LSR zp,X*/_A_ZPX();_RD();l=_GD();_WR();c.P=(c.P&~M6502_CF)|((l&0x01)?M6502_CF:0);l>>=1;_NZ(l);_SD(l);_WR();break;
      ...
      case 0x5e:/*LSR abs,X*/_A_ABX_W();_RD();l=_GD();_WR();c.P=(c.P&~M6502_CF)|((l&0x01)?M6502_CF:0);l>>=1;_NZ(l);_SD(l);_WR();break;
      ...
      case 0x66:/*ROR zp*/_A_ZER();_RD();l=_GD();_WR();{bool carry=c.P&M6502_CF;c.P&=~(M6502_NF|M6502_ZF|M6502_CF);if(l&0x01){c.P|=M6502_CF;}l>>=1;if(carry){l|=0x80;}_NZ(l);}_SD(l);_WR();break;
      ...
      case 0x6e:/*ROR abs*/_A_ABS();_RD();l=_GD();_WR();{bool carry=c.P&M6502_CF;c.P&=~(M6502_NF|M6502_ZF|M6502_CF);if(l&0x01){c.P|=M6502_CF;}l>>=1;if(carry){l|=0x80;}_NZ(l);}_SD(l);_WR();break;
      ...
      case 0x76:/*ROR zp,X*/_A_ZPX();_RD();l=_GD();_WR();{bool carry=c.P&M6502_CF;c.P&=~(M6502_NF|M6502_ZF|M6502_CF);if(l&0x01){c.P|=M6502_CF;}l>>=1;if(carry){l|=0x80;}_NZ(l);}_SD(l);_WR();break;
      ...
      case 0x7e:/*ROR abs,X*/_A_ABX_W();_RD();l=_GD();_WR();{bool carry=c.P&M6502_CF;c.P&=~(M6502_NF|M6502_ZF|M6502_CF);if(l&0x01){c.P|=M6502_CF;}l>>=1;if(carry){l|=0x80;}_NZ(l);}_SD(l);_WR();break;
