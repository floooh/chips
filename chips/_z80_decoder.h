uint32_t z80_exec(z80_t* cpu, uint32_t num_ticks) {
  ...
  do {
    ...
    switch (op) {
      ...
      case 0x3:/*INC BC*/_T(2);d16=_G_BC()+1;_S_BC(d16);break;
      case 0xa:/*LD A,(BC)*/addr=_G_BC();_MR(addr++,d8);_S_A(d8);_S_WZ(addr);break;
      case 0xb:/*DEC BC*/_T(2);d16=_G_BC()-1;_S_BC(d16);break;
      ...
      case 0x33:/*INC SP*/_T(2);d16=_G_SP()+1;_S_SP(d16);break;
      case 0x3a:/*LD A,(nn)*/_IMM16(addr);_MR(addr++,d8);_S_A(d8);_S_WZ(addr);break;
      case 0x3b:/*DEC SP*/_T(2);d16=_G_SP()-1;_S_SP(d16);break;
      ...
      case 0x66:/*LD H,(HL/IX+d/IY+d)*/_ADDR(addr,5);_MR(addr,d8);_S8(r0,_H,d8);break;
      ...
      case 0x6e:/*LD L,(HL/IX+d/IY+d)*/_ADDR(addr,5);_MR(addr,d8);_S8(r0,_L,d8);break;
