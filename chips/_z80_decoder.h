uint32_t z80_exec(z80_t* cpu, uint32_t num_ticks) {
  ...
  do {
    ...
    switch (op) {
      case 0x0:/*NOP*/ break;
      case 0x1:/*LD BC,nn*/_IMM16(d16,0);_S_BC(d16);break;
      case 0x2:/*LD (BC),A*/addr=_G_BC();d8=_G_A();_MW(addr++,d8,0);_S_WZ((d8<<8)|(addr&0x00FF));break;
      ...
      case 0x6:/*LD B,n*/_IMM8(d8,0);_S_B(d8);break;
      ...
      case 0xa:/*LD A,(BC)*/addr=_G_BC();_MR(addr++,d8,0);_S_A(d8);_S_WZ(addr);break;
      ...
      case 0xe:/*LD C,n*/_IMM8(d8,0);_S_C(d8);break;
      case 0xf:/*RRCA*/ws=_z80_rrca(ws);break;
      case 0x10:/*DJNZ*/{_T(1);int8_t d;_IMM8(d,0);d8=_G_B()-1;_S_B(d8);if(d8>0){pc+=d;_S_WZ(pc);_T(5);}}break;
      case 0x11:/*LD DE,nn*/_IMM16(d16,0);_S_DE(d16);break;
      case 0x12:/*LD (DE),A*/addr=_G_DE();d8=_G_A();_MW(addr++,d8,0);_S_WZ((d8<<8)|(addr&0x00FF));break;
      ...
      case 0x16:/*LD D,n*/_IMM8(d8,0);_S_D(d8);break;
      case 0x17:/*RLA*/ws=_z80_rla(ws);break;
      case 0x18:/*JR d*/{int8_t d;_IMM8(d,0);pc+=d;_S_WZ(pc);_T(5);}break;
      ...
      case 0x1a:/*LD A,(DE)*/addr=_G_DE();_MR(addr++,d8,0);_S_A(d8);_S_WZ(addr);break;
      ...
      case 0x1e:/*LD E,n*/_IMM8(d8,0);_S_E(d8);break;
      case 0x1f:/*RRA*/ws=_z80_rra(ws);break;
      case 0x20:/*JR NZ,d*/{int8_t d;_IMM8(d,0);if(!(_G_F()&Z80_ZF)){pc+=d;_S_WZ(pc);_T(5);}}break;
      case 0x21:/*LD HL,nn*/_IMM16(d16,0);_S_HL(d16);break;
      case 0x22:/*LD (nn),HL*/_IMM16(addr,0);_MW(addr++,_G_L(),0);_MW(addr,_G_H(),0);_S_WZ(addr);break;
      ...
      case 0x26:/*LD H,n*/_IMM8(d8,0);_S_H(d8);break;
      case 0x27:/*DAA*/ws=_z80_daa(ws);break;
      case 0x28:/*JR Z,d*/{int8_t d;_IMM8(d,0);if((_G_F()&Z80_ZF)){pc+=d;_S_WZ(pc);_T(5);}}break;
      ...
      case 0x2a:/*LD HL,(nn)*/_IMM16(addr,0);_MR(addr++,d8,0);_S_L(d8);_MR(addr,d8,0);_S_H(d8);_S_WZ(addr);break;
      ...
      case 0x2e:/*LD L,n*/_IMM8(d8,0);_S_L(d8);break;
      case 0x2f:/*CPL*/ws=_z80_cpl(ws);break;
      case 0x30:/*JR NC,d*/{int8_t d;_IMM8(d,0);if(!(_G_F()&Z80_CF)){pc+=d;_S_WZ(pc);_T(5);}}break;
      case 0x31:/*LD SP,nn*/_IMM16(d16,0);_S_SP(d16);break;
      case 0x32:/*LD (nn),A*/_IMM16(addr,0);d8=_G_A();_MW(addr++,d8,0);_S_WZ((d8<<8)|(addr&0x00FF));break;
      case 0x33:/*INC SP*/_T(2);_S_SP(_G_SP()+1);break;
      case 0x34:/*INC (HL/IX+d/IY+d)*/_ADDR(addr,5);_T(1);_MR(addr,d8,0);{uint8_t r=d8+1;uint8_t f=_SZ(r)|(r&(Z80_XF|Z80_YF))|((r^d8)&Z80_HF);if(r==0x80){f|=Z80_VF;}_S_F(f|(_G_F()&Z80_CF));d8=r;}_MW(addr,d8,0);break;
      case 0x35:/*DEC (HL/IX+d/IY+d)*/_ADDR(addr,5);_T(1);_MR(addr,d8,0);{uint8_t r=d8-1;uint8_t f=Z80_NF|_SZ(r)|(r&(Z80_XF|Z80_YF))|((r^d8)&Z80_HF);if(r==0x7F){f|=Z80_VF;}_S_F(f|(_G_F()&Z80_CF));d8=r;}_MW(addr,d8,0);break;
      case 0x36:/*LD (HL/IX+d/IY+d),n*/_ADDR(addr,2);_IMM8(d8,0);_MW(addr,d8,0);break;
      case 0x37:/*SCF*/ws=_z80_scf(ws);break;
      case 0x38:/*JR C,d*/{int8_t d;_IMM8(d,0);if((_G_F()&Z80_CF)){pc+=d;_S_WZ(pc);_T(5);}}break;
      ...
      case 0x3a:/*LD A,(nn)*/_IMM16(addr,0);_MR(addr++,d8,0);_S_A(d8);_S_WZ(addr);break;
      ...
      case 0x3e:/*LD A,n*/_IMM8(d8,0);_S_A(d8);break;
      ...
      case 0x46:/*LD B,(HL/IX+d/IY+d)*/_ADDR(addr,5);_MR(addr,d8,0);_S_B(d8);break;
      ...
      case 0x4e:/*LD C,(HL/IX+d/IY+d)*/_ADDR(addr,5);_MR(addr,d8,0);_S_C(d8);break;
      ...
      case 0x56:/*LD D,(HL/IX+d/IY+d)*/_ADDR(addr,5);_MR(addr,d8,0);_S_D(d8);break;
      ...
      case 0x5e:/*LD E,(HL/IX+d/IY+d)*/_ADDR(addr,5);_MR(addr,d8,0);_S_E(d8);break;
      ...
      case 0x66:/*LD H,(HL/IX+d/IY+d)*/_ADDR(addr,5);_MR(addr,d8,0);if(_IDX()){_S8(r0,_H,d8);}else{_S_H(d8);}break;
      ...
      case 0x6e:/*LD L,(HL/IX+d/IY+d)*/_ADDR(addr,5);_MR(addr,d8,0);if(_IDX()){_S8(r0,_L,d8);}else{_S_L(d8);}break;
      case 0x6f:/*LD L,A*/_S_L(_G_A());break;
      case 0x70:/*LD (HL/IX+d/IY+d),B*/d8=_G_B();_ADDR(addr,5);_MW(addr,d8,0);break;
      case 0x71:/*LD (HL/IX+d/IY+d),C*/d8=_G_C();_ADDR(addr,5);_MW(addr,d8,0);break;
      case 0x72:/*LD (HL/IX+d/IY+d),D*/d8=_G_D();_ADDR(addr,5);_MW(addr,d8,0);break;
      case 0x73:/*LD (HL/IX+d/IY+d),E*/d8=_G_E();_ADDR(addr,5);_MW(addr,d8,0);break;
      case 0x74:/*LD (HL/IX+d/IY+d),H*/d8=_IDX()?_G8(r0,_H):_G_H();_ADDR(addr,5);_MW(addr,d8,0);break;
      case 0x75:/*LD (HL/IX+d/IY+d),L*/d8=_IDX()?_G8(r0,_L):_G_L();_ADDR(addr,5);_MW(addr,d8,0);break;
      case 0x76:/*HALT*/pins|=Z80_HALT;pc--;break;
      case 0x77:/*LD (HL/IX+d/IY+d),A*/d8=_G_A();_ADDR(addr,5);_MW(addr,d8,0);break;
      ...
      case 0x7e:/*LD A,(HL/IX+d/IY+d)*/_ADDR(addr,5);_MR(addr,d8,0);_S_A(d8);break;
      ...
      case 0x86:/*ADD,(HL/IX+d/IY+d)*/_ADDR(addr,5);_MR(addr,d8,0);{uint8_t acc=_G_A();uint32_t res=acc+d8;_S_F(_ADD_FLAGS(acc,d8,res));_S_A(res);}break;
      ...
      case 0x8e:/*ADC,(HL/IX+d/IY+d)*/_ADDR(addr,5);_MR(addr,d8,0);{uint8_t acc=_G_A();uint32_t res=acc+d8+(_G_F()&Z80_CF);_S_F(_ADD_FLAGS(acc,d8,res));_S_A(res);}break;
      ...
      case 0x96:/*SUB,(HL/IX+d/IY+d)*/_ADDR(addr,5);_MR(addr,d8,0);{uint8_t acc=_G_A();uint32_t res=(uint32_t)((int)acc-(int)d8);_S_F(_SUB_FLAGS(acc,d8,res));_S_A(res);}break;
      ...
      case 0x9e:/*SBC,(HL/IX+d/IY+d)*/_ADDR(addr,5);_MR(addr,d8,0);{uint8_t acc=_G_A();uint32_t res=(uint32_t)((int)acc-(int)d8-(_G_F()&Z80_CF));_S_F(_SUB_FLAGS(acc,d8,res));_S_A(res);}break;
      ...
      case 0xa6:/*AND,(HL/IX+d/IY+d)*/_ADDR(addr,5);_MR(addr,d8,0);{d8&=_G_A();_S_F(_z80_szp[d8]|Z80_HF);_S_A(d8);}break;
      ...
      case 0xae:/*XOR,(HL/IX+d/IY+d)*/_ADDR(addr,5);_MR(addr,d8,0);{d8^=_G_A();_S_F(_z80_szp[d8]);_S_A(d8);}break;
      ...
      case 0xb6:/*OR,(HL/IX+d/IY+d)*/_ADDR(addr,5);_MR(addr,d8,0);{d8|=_G_A();_S_F(_z80_szp[d8]);_S_A(d8);}break;
      ...
      case 0xbe:/*CP,(HL/IX+d/IY+d)*/_ADDR(addr,5);_MR(addr,d8,0);{uint8_t acc=_G_A();int32_t res=(uint32_t)((int)acc-(int)d8);_S_F(_CP_FLAGS(acc,d8,res));}break;
      case 0xbf:/*CP A*/d8=_G_A();{uint8_t acc=_G_A();int32_t res=(uint32_t)((int)acc-(int)d8);_S_F(_CP_FLAGS(acc,d8,res));}break;
      case 0xc0:/*RET NZ*/_T(1);if (!(_G_F()&Z80_ZF)){uint8_t w,z;d16=_G_SP();_MR(d16++,z,0);_MR(d16++,w,0);_S_SP(d16);pc=(w<<8)|z;_S_WZ(pc);}break;
      case 0xc1:/*POP BC*/addr=_G_SP();_MR(addr++,d8,0);d16=d8;_MR(addr++,d8,0);d16|=d8<<8;_S_BC(d16);_S_SP(addr);break;
      case 0xc2:/*JP NZ,nn*/_IMM16(addr,0);if(!(_G_F()&Z80_ZF)){pc=addr;}break;
      case 0xc3:/*JP nn*/_IMM16(pc,0);break;
      case 0xc4:/*CALL NZ,nn*/_IMM16(addr,0);if(!(_G_F()&Z80_ZF)){_T(1);uint16_t sp=_G_SP();_MW(--sp,pc>>8,0);_MW(--sp,pc,0);_S_SP(sp);pc=addr;}break;
      case 0xc5:/*PUSH BC*/_T(1);addr=_G_SP();d16=_G_BC();_MW(--addr,d16>>8,0);_MW(--addr,d16,0);_S_SP(addr);break;
      case 0xc6:/*ADD n*/_IMM8(d8,0);{uint8_t acc=_G_A();uint32_t res=acc+d8;_S_F(_ADD_FLAGS(acc,d8,res));_S_A(res);}break;
      case 0xc7:/*RST 0x0*/_T(1);d16= _G_SP();_MW(--d16,pc>>8,0);_MW(--d16,pc,0);_S_SP(d16);pc=0x0;_S_WZ(pc);break;
      case 0xc8:/*RET Z*/_T(1);if ((_G_F()&Z80_ZF)){uint8_t w,z;d16=_G_SP();_MR(d16++,z,0);_MR(d16++,w,0);_S_SP(d16);pc=(w<<8)|z;_S_WZ(pc);}break;
      case 0xc9:/*RET*/d16=_G_SP();_MR(d16++,d8,0);pc=d8;_MR(d16++,d8,0);pc|=d8<<8;_S_SP(d16);_S_WZ(pc);break;
      case 0xca:/*JP Z,nn*/_IMM16(addr,0);if((_G_F()&Z80_ZF)){pc=addr;}break;
      case 0xCB: {
      ...
      break;
      case 0xcc:/*CALL Z,nn*/_IMM16(addr,0);if((_G_F()&Z80_ZF)){_T(1);uint16_t sp=_G_SP();_MW(--sp,pc>>8,0);_MW(--sp,pc,0);_S_SP(sp);pc=addr;}break;
      case 0xcd:/*CALL nn*/_IMM16(addr,0);_T(1);d16=_G_SP();_MW(--d16,pc>>8,0);_MW(--d16,pc,0);_S_SP(d16);pc=addr;break;
      case 0xce:/*ADC n*/_IMM8(d8,0);{uint8_t acc=_G_A();uint32_t res=acc+d8+(_G_F()&Z80_CF);_S_F(_ADD_FLAGS(acc,d8,res));_S_A(res);}break;
      case 0xcf:/*RST 0x8*/_T(1);d16= _G_SP();_MW(--d16,pc>>8,0);_MW(--d16,pc,0);_S_SP(d16);pc=0x8;_S_WZ(pc);break;
      case 0xd0:/*RET NC*/_T(1);if (!(_G_F()&Z80_CF)){uint8_t w,z;d16=_G_SP();_MR(d16++,z,0);_MR(d16++,w,0);_S_SP(d16);pc=(w<<8)|z;_S_WZ(pc);}break;
      case 0xd1:/*POP DE*/addr=_G_SP();_MR(addr++,d8,0);d16=d8;_MR(addr++,d8,0);d16|=d8<<8;_S_DE(d16);_S_SP(addr);break;
      case 0xd2:/*JP NC,nn*/_IMM16(addr,0);if(!(_G_F()&Z80_CF)){pc=addr;}break;
      case 0xd3:/*OUT (n),A*/{_IMM8(d8,0);uint8_t a=_G_A();addr=(a<<8)|d8;_OUT(addr,a,0);_S_WZ((addr&0xFF00)|((addr+1)&0x00FF));}break;
      case 0xd4:/*CALL NC,nn*/_IMM16(addr,0);if(!(_G_F()&Z80_CF)){_T(1);uint16_t sp=_G_SP();_MW(--sp,pc>>8,0);_MW(--sp,pc,0);_S_SP(sp);pc=addr;}break;
      case 0xd5:/*PUSH DE*/_T(1);addr=_G_SP();d16=_G_DE();_MW(--addr,d16>>8,0);_MW(--addr,d16,0);_S_SP(addr);break;
      case 0xd6:/*SUB n*/_IMM8(d8,0);{uint8_t acc=_G_A();uint32_t res=(uint32_t)((int)acc-(int)d8);_S_F(_SUB_FLAGS(acc,d8,res));_S_A(res);}break;
      case 0xd7:/*RST 0x10*/_T(1);d16= _G_SP();_MW(--d16,pc>>8,0);_MW(--d16,pc,0);_S_SP(d16);pc=0x10;_S_WZ(pc);break;
      case 0xd8:/*RET C*/_T(1);if ((_G_F()&Z80_CF)){uint8_t w,z;d16=_G_SP();_MR(d16++,z,0);_MR(d16++,w,0);_S_SP(d16);pc=(w<<8)|z;_S_WZ(pc);}break;
      ...
      case 0xda:/*JP C,nn*/_IMM16(addr,0);if((_G_F()&Z80_CF)){pc=addr;}break;
      case 0xdb:/*IN A,(n)*/{_IMM8(d8,0);uint8_t a=_G_A();addr=(a<<8)|d8;_IN(addr++,a,0);_S_A(a);_S_WZ(addr);}break;
      case 0xdc:/*CALL C,nn*/_IMM16(addr,0);if((_G_F()&Z80_CF)){_T(1);uint16_t sp=_G_SP();_MW(--sp,pc>>8,0);_MW(--sp,pc,0);_S_SP(sp);pc=addr;}break;
      case 0xdd:/*DD prefix*/map_bits|=_BIT_USE_IX;continue;break;
      case 0xde:/*SBC n*/_IMM8(d8,0);{uint8_t acc=_G_A();uint32_t res=(uint32_t)((int)acc-(int)d8-(_G_F()&Z80_CF));_S_F(_SUB_FLAGS(acc,d8,res));_S_A(res);}break;
      case 0xdf:/*RST 0x18*/_T(1);d16= _G_SP();_MW(--d16,pc>>8,0);_MW(--d16,pc,0);_S_SP(d16);pc=0x18;_S_WZ(pc);break;
      case 0xe0:/*RET PO*/_T(1);if (!(_G_F()&Z80_PF)){uint8_t w,z;d16=_G_SP();_MR(d16++,z,0);_MR(d16++,w,0);_S_SP(d16);pc=(w<<8)|z;_S_WZ(pc);}break;
      case 0xe1:/*POP HL*/addr=_G_SP();_MR(addr++,d8,0);d16=d8;_MR(addr++,d8,0);d16|=d8<<8;_S_HL(d16);_S_SP(addr);break;
      case 0xe2:/*JP PO,nn*/_IMM16(addr,0);if(!(_G_F()&Z80_PF)){pc=addr;}break;
      case 0xe3:/*EX (SP),HL*/{_T(3);addr=_G_SP();d16=_G_HL();uint8_t l,h;_MR(addr,l,0);_MR(addr+1,h,0);_MW(addr,d16,0);_MW(addr+1,d16>>8,0);d16=(h<<8)|l;_S_HL(d16);_S_WZ(d16);}break;
      case 0xe4:/*CALL PO,nn*/_IMM16(addr,0);if(!(_G_F()&Z80_PF)){_T(1);uint16_t sp=_G_SP();_MW(--sp,pc>>8,0);_MW(--sp,pc,0);_S_SP(sp);pc=addr;}break;
      case 0xe5:/*PUSH HL*/_T(1);addr=_G_SP();d16=_G_HL();_MW(--addr,d16>>8,0);_MW(--addr,d16,0);_S_SP(addr);break;
      case 0xe6:/*AND n*/_IMM8(d8,0);{d8&=_G_A();_S_F(_z80_szp[d8]|Z80_HF);_S_A(d8);}break;
      case 0xe7:/*RST 0x20*/_T(1);d16= _G_SP();_MW(--d16,pc>>8,0);_MW(--d16,pc,0);_S_SP(d16);pc=0x20;_S_WZ(pc);break;
      case 0xe8:/*RET PE*/_T(1);if ((_G_F()&Z80_PF)){uint8_t w,z;d16=_G_SP();_MR(d16++,z,0);_MR(d16++,w,0);_S_SP(d16);pc=(w<<8)|z;_S_WZ(pc);}break;
      case 0xe9:/*JP HL*/pc=_G_HL();break;
      case 0xea:/*JP PE,nn*/_IMM16(addr,0);if((_G_F()&Z80_PF)){pc=addr;}break;
      ...
      case 0xec:/*CALL PE,nn*/_IMM16(addr,0);if((_G_F()&Z80_PF)){_T(1);uint16_t sp=_G_SP();_MW(--sp,pc>>8,0);_MW(--sp,pc,0);_S_SP(sp);pc=addr;}break;
      case 0xED: {
        _FETCH(op);
        switch(op) {
          case 0x40:/*IN B,(C)*/{addr=_G_BC();_IN(addr++,d8,0);_S_WZ(addr);uint8_t f=(_G_F()&Z80_CF)|_z80_szp[d8];_S8(ws,_F,f);_S_B(d8);}break;
          case 0x41:/*OUT (C),B*/addr=_G_BC();_OUT(addr++,_G_B(),0);_S_WZ(addr);break;
          ...
          case 0x43:/*LD (nn),BC*/_IMM16(addr,0);d16=_G_BC();_MW(addr++,d16&0xFF,0);_MW(addr,d16>>8,0);_S_WZ(addr);break;
          ...
          case 0x45:/*RETN*/pins|=Z80_RETI;d16=_G_SP();_MR(d16++,d8,0);pc=d8;_MR(d16++,d8,0);pc|=d8<<8;_S_SP(d16);_S_WZ(pc);if (r2&_BIT_IFF2){r2|=_BIT_IFF1;}else{r2&=~_BIT_IFF1;}break;
          case 0x46:/*IM 0*/_S_IM(0);break;
          case 0x47:/*LD I,A*/_T(1);_S_I(_G_A());break;
          case 0x48:/*IN C,(C)*/{addr=_G_BC();_IN(addr++,d8,0);_S_WZ(addr);uint8_t f=(_G_F()&Z80_CF)|_z80_szp[d8];_S8(ws,_F,f);_S_C(d8);}break;
          case 0x49:/*OUT (C),C*/addr=_G_BC();_OUT(addr++,_G_C(),0);_S_WZ(addr);break;
          ...
          case 0x4b:/*LD BC,(nn)*/_IMM16(addr,0);_MR(addr++,d8,0);d16=d8;_MR(addr,d8,0);d16|=d8<<8;_S_BC(d16);_S_WZ(addr);break;
          ...
          case 0x4d:/*RETI*/pins|=Z80_RETI;d16=_G_SP();_MR(d16++,d8,0);pc=d8;_MR(d16++,d8,0);pc|=d8<<8;_S_SP(d16);_S_WZ(pc);break;
          case 0x4e:/*IM 0*/_S_IM(0);break;
          case 0x4f:/*LD R,A*/_T(1);_S_R(_G_A());break;
          case 0x50:/*IN D,(C)*/{addr=_G_BC();_IN(addr++,d8,0);_S_WZ(addr);uint8_t f=(_G_F()&Z80_CF)|_z80_szp[d8];_S8(ws,_F,f);_S_D(d8);}break;
          case 0x51:/*OUT (C),D*/addr=_G_BC();_OUT(addr++,_G_D(),0);_S_WZ(addr);break;
          ...
          case 0x53:/*LD (nn),DE*/_IMM16(addr,0);d16=_G_DE();_MW(addr++,d16&0xFF,0);_MW(addr,d16>>8,0);_S_WZ(addr);break;
          ...
          case 0x55:/*RETN*/pins|=Z80_RETI;d16=_G_SP();_MR(d16++,d8,0);pc=d8;_MR(d16++,d8,0);pc|=d8<<8;_S_SP(d16);_S_WZ(pc);if (r2&_BIT_IFF2){r2|=_BIT_IFF1;}else{r2&=~_BIT_IFF1;}break;
          case 0x56:/*IM 1*/_S_IM(1);break;
          case 0x57:/*LD A,I*/_T(1);d8=_G_I();_S_A(d8);_S_F(_SZIFF2_FLAGS(d8));break;
          case 0x58:/*IN E,(C)*/{addr=_G_BC();_IN(addr++,d8,0);_S_WZ(addr);uint8_t f=(_G_F()&Z80_CF)|_z80_szp[d8];_S8(ws,_F,f);_S_E(d8);}break;
          case 0x59:/*OUT (C),E*/addr=_G_BC();_OUT(addr++,_G_E(),0);_S_WZ(addr);break;
          ...
          case 0x5b:/*LD DE,(nn)*/_IMM16(addr,0);_MR(addr++,d8,0);d16=d8;_MR(addr,d8,0);d16|=d8<<8;_S_DE(d16);_S_WZ(addr);break;
          ...
          case 0x5d:/*RETN*/pins|=Z80_RETI;d16=_G_SP();_MR(d16++,d8,0);pc=d8;_MR(d16++,d8,0);pc|=d8<<8;_S_SP(d16);_S_WZ(pc);if (r2&_BIT_IFF2){r2|=_BIT_IFF1;}else{r2&=~_BIT_IFF1;}break;
          case 0x5e:/*IM 2*/_S_IM(2);break;
          case 0x5f:/*LD A,R*/_T(1);d8=_G_R();_S_A(d8);_S_F(_SZIFF2_FLAGS(d8));break;
          case 0x60:/*IN H,(C)*/{addr=_G_BC();_IN(addr++,d8,0);_S_WZ(addr);uint8_t f=(_G_F()&Z80_CF)|_z80_szp[d8];_S8(ws,_F,f);_S_H(d8);}break;
          case 0x61:/*OUT (C),H*/addr=_G_BC();_OUT(addr++,_G_H(),0);_S_WZ(addr);break;
          ...
          case 0x63:/*LD (nn),HL*/_IMM16(addr,0);d16=_G_HL();_MW(addr++,d16&0xFF,0);_MW(addr,d16>>8,0);_S_WZ(addr);break;
          ...
          case 0x65:/*RETN*/pins|=Z80_RETI;d16=_G_SP();_MR(d16++,d8,0);pc=d8;_MR(d16++,d8,0);pc|=d8<<8;_S_SP(d16);_S_WZ(pc);if (r2&_BIT_IFF2){r2|=_BIT_IFF1;}else{r2&=~_BIT_IFF1;}break;
          case 0x66:/*IM 0*/_S_IM(0);break;
          case 0x67:/*RRD*/{addr=_G_HL();uint8_t a=_G_A();_MR(addr,d8,0);uint8_t l=a&0x0F;a=(a&0xF0)|(d8&0x0F);_S_A(a);d8=(d8>>4)|(l<<4);_MW(addr++,d8,0);_S_WZ(addr);_S_F((_G_F()&Z80_CF)|_z80_szp[a]);_T(4);}break;
          case 0x68:/*IN L,(C)*/{addr=_G_BC();_IN(addr++,d8,0);_S_WZ(addr);uint8_t f=(_G_F()&Z80_CF)|_z80_szp[d8];_S8(ws,_F,f);_S_L(d8);}break;
          case 0x69:/*OUT (C),L*/addr=_G_BC();_OUT(addr++,_G_L(),0);_S_WZ(addr);break;
          ...
          case 0x6b:/*LD HL,(nn)*/_IMM16(addr,0);_MR(addr++,d8,0);d16=d8;_MR(addr,d8,0);d16|=d8<<8;_S_HL(d16);_S_WZ(addr);break;
          ...
          case 0x6d:/*RETN*/pins|=Z80_RETI;d16=_G_SP();_MR(d16++,d8,0);pc=d8;_MR(d16++,d8,0);pc|=d8<<8;_S_SP(d16);_S_WZ(pc);if (r2&_BIT_IFF2){r2|=_BIT_IFF1;}else{r2&=~_BIT_IFF1;}break;
          case 0x6e:/*IM 0*/_S_IM(0);break;
          case 0x6f:/*RLD*/{addr=_G_HL();uint8_t a=_G_A();_MR(addr,d8,0);uint8_t l=a&0x0F;a=(a&0xF0)|(d8>>4);_S_A(a);d8=(d8<<4)|l;_MW(addr++,d8,0);_S_WZ(addr);_S_F((_G_F()&Z80_CF)|_z80_szp[a]);_T(4);}break;
          case 0x70:/*IN HL,(C)*/{addr=_G_BC();_IN(addr++,d8,0);_S_WZ(addr);uint8_t f=(_G_F()&Z80_CF)|_z80_szp[d8];_S8(ws,_F,f);}break;
          case 0x71:/*OUT (C),HL*/addr=_G_BC();_OUT(addr++,0,0);_S_WZ(addr);break;
          ...
          case 0x73:/*LD (nn),SP*/_IMM16(addr,0);d16=_G_SP();_MW(addr++,d16&0xFF,0);_MW(addr,d16>>8,0);_S_WZ(addr);break;
          ...
          case 0x75:/*RETN*/pins|=Z80_RETI;d16=_G_SP();_MR(d16++,d8,0);pc=d8;_MR(d16++,d8,0);pc|=d8<<8;_S_SP(d16);_S_WZ(pc);if (r2&_BIT_IFF2){r2|=_BIT_IFF1;}else{r2&=~_BIT_IFF1;}break;
          case 0x76:/*IM 1*/_S_IM(1);break;
          case 0x77:/*NOP (ED)*/ break;
          case 0x78:/*IN A,(C)*/{addr=_G_BC();_IN(addr++,d8,0);_S_WZ(addr);uint8_t f=(_G_F()&Z80_CF)|_z80_szp[d8];_S8(ws,_F,f);_S_A(d8);}break;
          case 0x79:/*OUT (C),A*/addr=_G_BC();_OUT(addr++,_G_A(),0);_S_WZ(addr);break;
          ...
          case 0x7b:/*LD SP,(nn)*/_IMM16(addr,0);_MR(addr++,d8,0);d16=d8;_MR(addr,d8,0);d16|=d8<<8;_S_SP(d16);_S_WZ(addr);break;
          ...
          case 0x7d:/*RETN*/pins|=Z80_RETI;d16=_G_SP();_MR(d16++,d8,0);pc=d8;_MR(d16++,d8,0);pc|=d8<<8;_S_SP(d16);_S_WZ(pc);if (r2&_BIT_IFF2){r2|=_BIT_IFF1;}else{r2&=~_BIT_IFF1;}break;
          case 0x7e:/*IM 2*/_S_IM(2);break;
          case 0x7f:/*NOP (ED)*/ break;
          case 0xa0:/*LDI*/{uint16_t hl=_G_HL();uint16_t de=_G_DE();_MR(hl,d8,0);_MW(de,d8,0);hl++;de++;_S_HL(hl);_S_DE(de);_T(2);d8+=_G_A();uint8_t f=_G_F()&(Z80_SF|Z80_ZF|Z80_CF);if(d8&0x02){f|=Z80_YF;}if(d8&0x08){f|=Z80_XF;}uint16_t bc=_G_BC();bc--;_S_BC(bc);if(bc){f|=Z80_VF;}_S_F(f);}break;
          case 0xa1:/*CPI*/{uint16_t hl = _G_HL();_MR(hl,d8,0);uint16_t wz = _G_WZ();hl++;wz++;_S_WZ(wz);_S_HL(hl);_T(5);int r=((int)_G_A())-d8;uint8_t f=(_G_F()&Z80_CF)|Z80_NF|_SZ(r);if((r&0x0F)>(_G_A()&0x0F)){f|=Z80_HF;r--;}if(r&0x02){f|=Z80_YF;}if(r&0x08){f|=Z80_XF;}uint16_t bc=_G_BC();bc--;_S_BC(bc);if(bc){f|=Z80_VF;}_S8(ws,_F,f);}break;
          case 0xa2:/*INI*/{_T(1);addr=_G_BC();uint16_t hl=_G_HL();_IN(addr,d8,0);_MW(hl,d8,0);uint8_t b=_G_B();uint8_t c=_G_C();b--;addr++;hl++;c++;_S_B(b);_S_HL(hl);_S_WZ(addr);uint8_t f=(b?(b&Z80_SF):Z80_ZF)|(b&(Z80_XF|Z80_YF));if(d8&Z80_SF){f|=Z80_NF;}uint32_t t=(uint32_t)(c&0xFF)+d8;if(t&0x100){f|=Z80_HF|Z80_CF;}f|=_z80_szp[((uint8_t)(t&0x07))^b]&Z80_PF;_S_F(f);}break;
          case 0xa3:/*OUTI*/{_T(1);uint16_t hl=_G_HL();_MR(hl,d8,0);uint8_t b=_G_B();b--;_S_B(b);addr=_G_BC();_OUT(addr,d8,0);addr++; hl++;_S_HL(hl);_S_WZ(addr);uint8_t f=(b?(b&Z80_SF):Z80_ZF)|(b&(Z80_XF|Z80_YF));if(d8&Z80_SF){f|=Z80_NF;}uint32_t t=(uint32_t)_G_L()+(uint32_t)d8;if (t&0x0100){f|=Z80_HF|Z80_CF;}f|=_z80_szp[((uint8_t)(t&0x07))^b]&Z80_PF;_S_F(f);}break;
          case 0xa8:/*LDD*/{uint16_t hl=_G_HL();uint16_t de=_G_DE();_MR(hl,d8,0);_MW(de,d8,0);hl--;de--;_S_HL(hl);_S_DE(de);_T(2);d8+=_G_A();uint8_t f=_G_F()&(Z80_SF|Z80_ZF|Z80_CF);if(d8&0x02){f|=Z80_YF;}if(d8&0x08){f|=Z80_XF;}uint16_t bc=_G_BC();bc--;_S_BC(bc);if(bc){f|=Z80_VF;}_S_F(f);}break;
          case 0xa9:/*CPD*/{uint16_t hl = _G_HL();_MR(hl,d8,0);uint16_t wz = _G_WZ();hl--;wz--;_S_WZ(wz);_S_HL(hl);_T(5);int r=((int)_G_A())-d8;uint8_t f=(_G_F()&Z80_CF)|Z80_NF|_SZ(r);if((r&0x0F)>(_G_A()&0x0F)){f|=Z80_HF;r--;}if(r&0x02){f|=Z80_YF;}if(r&0x08){f|=Z80_XF;}uint16_t bc=_G_BC();bc--;_S_BC(bc);if(bc){f|=Z80_VF;}_S8(ws,_F,f);}break;
          case 0xaa:/*IND*/{_T(1);addr=_G_BC();uint16_t hl=_G_HL();_IN(addr,d8,0);_MW(hl,d8,0);uint8_t b=_G_B();uint8_t c=_G_C();b--;addr--;hl--;c--;_S_B(b);_S_HL(hl);_S_WZ(addr);uint8_t f=(b?(b&Z80_SF):Z80_ZF)|(b&(Z80_XF|Z80_YF));if(d8&Z80_SF){f|=Z80_NF;}uint32_t t=(uint32_t)(c&0xFF)+d8;if(t&0x100){f|=Z80_HF|Z80_CF;}f|=_z80_szp[((uint8_t)(t&0x07))^b]&Z80_PF;_S_F(f);}break;
          case 0xab:/*OUTD*/{_T(1);uint16_t hl=_G_HL();_MR(hl,d8,0);uint8_t b=_G_B();b--;_S_B(b);addr=_G_BC();_OUT(addr,d8,0);addr--;hl--;_S_HL(hl);_S_WZ(addr);uint8_t f=(b?(b&Z80_SF):Z80_ZF)|(b&(Z80_XF|Z80_YF));if(d8&Z80_SF){f|=Z80_NF;}uint32_t t=(uint32_t)_G_L()+(uint32_t)d8;if (t&0x0100){f|=Z80_HF|Z80_CF;}f|=_z80_szp[((uint8_t)(t&0x07))^b]&Z80_PF;_S_F(f);}break;
          case 0xb0:/*LDIR*/{uint16_t hl=_G_HL();uint16_t de=_G_DE();_MR(hl,d8,0);_MW(de,d8,0);hl++;de++;_S_HL(hl);_S_DE(de);_T(2);d8+=_G_A();uint8_t f=_G_F()&(Z80_SF|Z80_ZF|Z80_CF);if(d8&0x02){f|=Z80_YF;}if(d8&0x08){f|=Z80_XF;}uint16_t bc=_G_BC();bc--;_S_BC(bc);if(bc){f|=Z80_VF;}_S_F(f);if(bc){pc-=2;_S_WZ(pc+1);_T(5);}}break;
          case 0xb1:/*CPIR*/{uint16_t hl = _G_HL();_MR(hl,d8,0);uint16_t wz = _G_WZ();hl++;wz++;_S_WZ(wz);_S_HL(hl);_T(5);int r=((int)_G_A())-d8;uint8_t f=(_G_F()&Z80_CF)|Z80_NF|_SZ(r);if((r&0x0F)>(_G_A()&0x0F)){f|=Z80_HF;r--;}if(r&0x02){f|=Z80_YF;}if(r&0x08){f|=Z80_XF;}uint16_t bc=_G_BC();bc--;_S_BC(bc);if(bc){f|=Z80_VF;}_S8(ws,_F,f);if(bc&&!(f&Z80_ZF)){pc-=2;_S_WZ(pc+1);_T(5);}}break;
          case 0xb2:/*INIR*/{_T(1);addr=_G_BC();uint16_t hl=_G_HL();_IN(addr,d8,0);_MW(hl,d8,0);uint8_t b=_G_B();uint8_t c=_G_C();b--;addr++;hl++;c++;_S_B(b);_S_HL(hl);_S_WZ(addr);uint8_t f=(b?(b&Z80_SF):Z80_ZF)|(b&(Z80_XF|Z80_YF));if(d8&Z80_SF){f|=Z80_NF;}uint32_t t=(uint32_t)(c&0xFF)+d8;if(t&0x100){f|=Z80_HF|Z80_CF;}f|=_z80_szp[((uint8_t)(t&0x07))^b]&Z80_PF;_S_F(f);if(b){pc-=2;_T(5);}}break;
          case 0xb3:/*OTIR*/{_T(1);uint16_t hl=_G_HL();_MR(hl,d8,0);uint8_t b=_G_B();b--;_S_B(b);addr=_G_BC();_OUT(addr,d8,0);addr++; hl++;_S_HL(hl);_S_WZ(addr);uint8_t f=(b?(b&Z80_SF):Z80_ZF)|(b&(Z80_XF|Z80_YF));if(d8&Z80_SF){f|=Z80_NF;}uint32_t t=(uint32_t)_G_L()+(uint32_t)d8;if (t&0x0100){f|=Z80_HF|Z80_CF;}f|=_z80_szp[((uint8_t)(t&0x07))^b]&Z80_PF;_S_F(f);if(b){pc-=2;_T(5);}}break;
          case 0xb8:/*LDDR*/{uint16_t hl=_G_HL();uint16_t de=_G_DE();_MR(hl,d8,0);_MW(de,d8,0);hl--;de--;_S_HL(hl);_S_DE(de);_T(2);d8+=_G_A();uint8_t f=_G_F()&(Z80_SF|Z80_ZF|Z80_CF);if(d8&0x02){f|=Z80_YF;}if(d8&0x08){f|=Z80_XF;}uint16_t bc=_G_BC();bc--;_S_BC(bc);if(bc){f|=Z80_VF;}_S_F(f);if(bc){pc-=2;_S_WZ(pc+1);_T(5);}}break;
          case 0xb9:/*CPDR*/{uint16_t hl = _G_HL();_MR(hl,d8,0);uint16_t wz = _G_WZ();hl--;wz--;_S_WZ(wz);_S_HL(hl);_T(5);int r=((int)_G_A())-d8;uint8_t f=(_G_F()&Z80_CF)|Z80_NF|_SZ(r);if((r&0x0F)>(_G_A()&0x0F)){f|=Z80_HF;r--;}if(r&0x02){f|=Z80_YF;}if(r&0x08){f|=Z80_XF;}uint16_t bc=_G_BC();bc--;_S_BC(bc);if(bc){f|=Z80_VF;}_S8(ws,_F,f);if(bc&&!(f&Z80_ZF)){pc-=2;_S_WZ(pc+1);_T(5);}}break;
          case 0xba:/*INDR*/{_T(1);addr=_G_BC();uint16_t hl=_G_HL();_IN(addr,d8,0);_MW(hl,d8,0);uint8_t b=_G_B();uint8_t c=_G_C();b--;addr--;hl--;c--;_S_B(b);_S_HL(hl);_S_WZ(addr);uint8_t f=(b?(b&Z80_SF):Z80_ZF)|(b&(Z80_XF|Z80_YF));if(d8&Z80_SF){f|=Z80_NF;}uint32_t t=(uint32_t)(c&0xFF)+d8;if(t&0x100){f|=Z80_HF|Z80_CF;}f|=_z80_szp[((uint8_t)(t&0x07))^b]&Z80_PF;_S_F(f);if(b){pc-=2;_T(5);}}break;
          case 0xbb:/*OTDR*/{_T(1);uint16_t hl=_G_HL();_MR(hl,d8,0);uint8_t b=_G_B();b--;_S_B(b);addr=_G_BC();_OUT(addr,d8,0);addr--;hl--;_S_HL(hl);_S_WZ(addr);uint8_t f=(b?(b&Z80_SF):Z80_ZF)|(b&(Z80_XF|Z80_YF));if(d8&Z80_SF){f|=Z80_NF;}uint32_t t=(uint32_t)_G_L()+(uint32_t)d8;if (t&0x0100){f|=Z80_HF|Z80_CF;}f|=_z80_szp[((uint8_t)(t&0x07))^b]&Z80_PF;_S_F(f);if(b){pc-=2;_T(5);}}break;
          default: break;
        }
      }
      break;
      case 0xee:/*XOR n*/_IMM8(d8,0);{d8^=_G_A();_S_F(_z80_szp[d8]);_S_A(d8);}break;
      case 0xef:/*RST 0x28*/_T(1);d16= _G_SP();_MW(--d16,pc>>8,0);_MW(--d16,pc,0);_S_SP(d16);pc=0x28;_S_WZ(pc);break;
      case 0xf0:/*RET P*/_T(1);if (!(_G_F()&Z80_SF)){uint8_t w,z;d16=_G_SP();_MR(d16++,z,0);_MR(d16++,w,0);_S_SP(d16);pc=(w<<8)|z;_S_WZ(pc);}break;
      case 0xf1:/*POP FA*/addr=_G_SP();_MR(addr++,d8,0);d16=d8<<8;_MR(addr++,d8,0);d16|=d8;_S_FA(d16);_S_SP(addr);break;
      case 0xf2:/*JP P,nn*/_IMM16(addr,0);if(!(_G_F()&Z80_SF)){pc=addr;}break;
      case 0xf3:/*DI*/r2&=~(_BIT_IFF1|_BIT_IFF2);break;
      case 0xf4:/*CALL P,nn*/_IMM16(addr,0);if(!(_G_F()&Z80_SF)){_T(1);uint16_t sp=_G_SP();_MW(--sp,pc>>8,0);_MW(--sp,pc,0);_S_SP(sp);pc=addr;}break;
      case 0xf5:/*PUSH FA*/_T(1);addr=_G_SP();d16=_G_FA();_MW(--addr,d16,0);_MW(--addr,d16>>8,0);_S_SP(addr);break;
      case 0xf6:/*OR n*/_IMM8(d8,0);{d8|=_G_A();_S_F(_z80_szp[d8]);_S_A(d8);}break;
      case 0xf7:/*RST 0x30*/_T(1);d16= _G_SP();_MW(--d16,pc>>8,0);_MW(--d16,pc,0);_S_SP(d16);pc=0x30;_S_WZ(pc);break;
      case 0xf8:/*RET M*/_T(1);if ((_G_F()&Z80_SF)){uint8_t w,z;d16=_G_SP();_MR(d16++,z,0);_MR(d16++,w,0);_S_SP(d16);pc=(w<<8)|z;_S_WZ(pc);}break;
      case 0xf9:/*LD SP,HL*/_T(2);_S_SP(_G_HL());break;
      case 0xfa:/*JP M,nn*/_IMM16(addr,0);if((_G_F()&Z80_SF)){pc=addr;}break;
      case 0xfb:/*EI*/r2|=_BIT_EI;break;
      case 0xfc:/*CALL M,nn*/_IMM16(addr,0);if((_G_F()&Z80_SF)){_T(1);uint16_t sp=_G_SP();_MW(--sp,pc>>8,0);_MW(--sp,pc,0);_S_SP(sp);pc=addr;}break;
      case 0xfd:/*FD prefix*/map_bits|=_BIT_USE_IY;continue;break;
      case 0xfe:/*CP n*/_IMM8(d8,0);{uint8_t acc=_G_A();int32_t res=(uint32_t)((int)acc-(int)d8);_S_F(_CP_FLAGS(acc,d8,res));}break;
      case 0xff:/*RST 0x38*/_T(1);d16= _G_SP();_MW(--d16,pc>>8,0);_MW(--d16,pc,0);_S_SP(d16);pc=0x38;_S_WZ(pc);break;
      default: break;
    }
