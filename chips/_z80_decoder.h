uint32_t z80_exec(z80_t* cpu, uint32_t num_ticks) {
  ...
  do {
    ...
    switch (op) {
      case 0x0:/*NOP*/ break;
      case 0x1:/*LD BC,nn*/_IMM16(d16);B=d16>>8;C=d16;break;
      ...
      case 0x11:/*LD DE,nn*/_IMM16(d16);D=d16>>8;E=d16;break;
      ...
      case 0x21:/*LD HL,nn*/_IMM16(d16);H=d16>>8;L=d16;break;
      case 0x22:/*LD (nn),HL*/_IMM16(WZ);_MW(WZ++,L);_MW(WZ,H);break;
      ...
      case 0x2a:/*LD HL,(nn)*/_IMM16(WZ);_MR(WZ++,L);_MR(WZ,H);break;
      ...
      case 0x31:/*LD SP,nn*/_IMM16(SP);break;
      case 0x32:/*LD (nn),A*/_IMM16(WZ);_MW(WZ++,A);WZ=(A<<8)|(WZ&0x00FF);break;
      ...
      case 0x3a:/*LD A,(nn)*/_IMM16(WZ);_MR(WZ++,A);break;
      ...
      case 0xc2:/*JP NZ,nn*/_IMM16(addr);if(!(F&Z80_ZF)){PC=addr;}break;
      case 0xc3:/*JP nn*/_IMM16(PC);break;
      case 0xc4:/*CALL NZ,nn*/_IMM16(addr);if(!(F&Z80_ZF)){_T(1);_MW(--SP,PC>>8);_MW(--SP,PC);PC=addr;}break;
      ...
      case 0xca:/*JP Z,nn*/_IMM16(addr);if((F&Z80_ZF)){PC=addr;}break;
      case 0xCB: {
      ...
      break;
      case 0xcc:/*CALL Z,nn*/_IMM16(addr);if((F&Z80_ZF)){_T(1);_MW(--SP,PC>>8);_MW(--SP,PC);PC=addr;}break;
      ...
      case 0xd2:/*JP NC,nn*/_IMM16(addr);if(!(F&Z80_CF)){PC=addr;}break;
      case 0xd3:/*OUT (n),A*/{_IMM8(d8);addr=(A<<8)|d8;_OUT(addr,A);WZ=(addr&0xFF00)|((addr+1)&0x00FF);}break;
      case 0xd4:/*CALL NC,nn*/_IMM16(addr);if(!(F&Z80_CF)){_T(1);_MW(--SP,PC>>8);_MW(--SP,PC);PC=addr;}break;
      ...
      case 0xda:/*JP C,nn*/_IMM16(addr);if((F&Z80_CF)){PC=addr;}break;
      case 0xdb:/*IN A,(n)*/{_IMM8(d8);WZ=(A<<8)|d8;_IN(WZ++,A);}break;
      case 0xdc:/*CALL C,nn*/_IMM16(addr);if((F&Z80_CF)){_T(1);_MW(--SP,PC>>8);_MW(--SP,PC);PC=addr;}break;
      ...
      case 0xe2:/*JP PO,nn*/_IMM16(addr);if(!(F&Z80_PF)){PC=addr;}break;
      case 0xe3:/*EX (SP),HL*/{_T(3);uint8_t l,h;_MR(SP,l);_MR(SP+1,h);_MW(SP,L);_MW(SP+1,H);HL=WZ=(h<<8)|l;}break;
      case 0xe4:/*CALL PO,nn*/_IMM16(addr);if(!(F&Z80_PF)){_T(1);_MW(--SP,PC>>8);_MW(--SP,PC);PC=addr;}break;
      ...
      case 0xea:/*JP PE,nn*/_IMM16(addr);if((F&Z80_PF)){PC=addr;}break;
      case 0xeb:/*EX DE,HL*/DE=DE^HL;HL=HL^DE;DE=DE^HL;break;
      case 0xec:/*CALL PE,nn*/_IMM16(addr);if((F&Z80_PF)){_T(1);_MW(--SP,PC>>8);_MW(--SP,PC);PC=addr;}break;
      case 0xED: {
        _FETCH(op);
        switch(op) {
          ...
          case 0x43:/*LD (nn),BC*/_IMM16(WZ);_MW(WZ++,C);_MW(WZ,B);break;
          ...
          case 0x4b:/*LD BC,(nn)*/_IMM16(WZ);_MR(WZ++,C);_MR(WZ,B);break;
          ...
          case 0x53:/*LD (nn),DE*/_IMM16(WZ);_MW(WZ++,E);_MW(WZ,D);break;
          ...
          case 0x5b:/*LD DE,(nn)*/_IMM16(WZ);_MR(WZ++,E);_MR(WZ,D);break;
          ...
          case 0x63:/*LD (nn),HL*/_IMM16(WZ);_MW(WZ++,L);_MW(WZ,H);break;
          ...
          case 0x6b:/*LD HL,(nn)*/_IMM16(WZ);_MR(WZ++,L);_MR(WZ,H);break;
          ...
          case 0x73:/*LD (nn),SP*/_IMM16(WZ);_MW(WZ++,SP);_MW(WZ,SP>>8);break;
          ...
          case 0x7b:/*LD SP,(nn)*/_IMM16(WZ);_MR(WZ++,SP);_MR(WZ,SP>>8);break;
      ...
      case 0xf2:/*JP P,nn*/_IMM16(addr);if(!(F&Z80_SF)){PC=addr;}break;
      case 0xf3:/*DI*/IFF1=IFF2=false;break;
      case 0xf4:/*CALL P,nn*/_IMM16(addr);if(!(F&Z80_SF)){_T(1);_MW(--SP,PC>>8);_MW(--SP,PC);PC=addr;}break;
      ...
      case 0xfa:/*JP M,nn*/_IMM16(addr);if((F&Z80_SF)){PC=addr;}break;
      case 0xfb:/*EI*/IFF1=IFF2=false;EI_PENDING=true;break;
      case 0xfc:/*CALL M,nn*/_IMM16(addr);if((F&Z80_SF)){_T(1);_MW(--SP,PC>>8);_MW(--SP,PC);PC=addr;}break;
