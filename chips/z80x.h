...
static const z80_opstate_t z80_opstate_table[256] = {
    ...
    { 0x000000010000000A, 0x0246 },
    // 0xFC: call m,nn (M:1 T:4 steps:2)
    { 0x000000010000000A, 0x0248 },
    // 0xFD: fd prefix (M:1 T:4 steps:2)
    { 0x000000010000000A, 0x024A },
    // 0xFE: cp n (M:1 T:4 steps:2)
    { 0x000000010000000A, 0x024C },
    // 0xFF: rst 38h (M:1 T:4 steps:2)
    { 0x000000010000000A, 0x024E },
...
uint64_t z80_tick(z80_t* cpu, uint64_t pins) {
    ...
    if (cpu->op.pip & Z80_PIP_BIT_STEP) {
        switch (cpu->op.step++) {
            ...
            // -- M2
            case 0x001B: _mread(cpu->bc);cpu->wz=cpu->bc+1; break;
            case 0x001C: cpu->a=_gd(); break;
            // -- OVERLAP
            ...
            case 0x002E: cpu->e=_gd(); break;
            // -- M3
            case 0x002F: _mread(cpu->pc++); break;
            case 0x0030: cpu->d=_gd(); break;
            // -- OVERLAP
            ...
            // -- M2
            case 0x0045: _mread(cpu->de);cpu->wz=cpu->de+1; break;
            case 0x0046: cpu->a=_gd(); break;
            // -- OVERLAP
            ...
            case 0x0058: cpu->l=_gd(); break;
            // -- M3
            case 0x0059: _mread(cpu->pc++); break;
            case 0x005A: cpu->h=_gd(); break;
            // -- OVERLAP
            ...
            // -- M2
            case 0x0077: _mread(cpu->pc++); break;
            case 0x0078: cpu->l=_gd(); break;
            // -- OVERLAP
            ...
            // -- M2
            case 0x007F: _mread(cpu->pc++); break;
            case 0x0080: cpu->spl=_gd(); break;
            // -- M3
            case 0x0081: _mread(cpu->pc++); break;
            case 0x0082: cpu->sph=_gd(); break;
            // -- OVERLAP
            ...
            // -- M2
            case 0x008D: _mread(cpu->pc++); break;
            case 0x008E: cpu->dlatch=_gd(); break;
            // -- M3
            case 0x008F: _mwrite(cpu->hl,cpu->dlatch); break;
            // -- OVERLAP
            ...
            case 0x0099: cpu->wzl=_gd(); break;
            // -- M3
            case 0x009A: _mread(cpu->pc++); break;
            case 0x009B: cpu->wzh=_gd(); break;
            // -- M4
            case 0x009C: _mread(cpu->wz++); break;
            ...
            // -- M2
            case 0x00A6: _mread(cpu->pc++); break;
            ...
            // -- OVERLAP
            case 0x00AC: cpu->b=cpu->b;_fetch(); break;
            ...
            // -- OVERLAP
            case 0x00B0: cpu->b=cpu->d;_fetch(); break;
            
            // 0x43: ld b,e (M:1 T:4)
            // -- M1
            case 0x00B1: _rfsh(); break;
            // -- OVERLAP
            case 0x00B2: cpu->b=cpu->e;_fetch(); break;
            
            // 0x44: ld b,h (M:1 T:4)
            // -- M1
            case 0x00B3: _rfsh(); break;
            // -- OVERLAP
            case 0x00B4: cpu->b=cpu->h;_fetch(); break;
            
            // 0x45: ld b,l (M:1 T:4)
            // -- M1
            case 0x00B5: _rfsh(); break;
            // -- OVERLAP
            case 0x00B6: cpu->b=cpu->l;_fetch(); break;
            
            // 0x46: ld b,(hl) (M:2 T:7)
            // -- M1
            case 0x00B7: _rfsh(); break;
            // -- M2
            case 0x00B8: _mread(cpu->hl); break;
            case 0x00B9: cpu->b=_gd(); break;
            // -- OVERLAP
            ...
            // -- OVERLAP
            case 0x00BE: cpu->c=cpu->b;_fetch(); break;
            
            // 0x49: ld c,c (M:1 T:4)
            // -- M1
            case 0x00BF: _rfsh(); break;
            // -- OVERLAP
            case 0x00C0: cpu->c=cpu->c;_fetch(); break;
            
            // 0x4A: ld c,d (M:1 T:4)
            // -- M1
            case 0x00C1: _rfsh(); break;
            // -- OVERLAP
            case 0x00C2: cpu->c=cpu->d;_fetch(); break;
            
            // 0x4B: ld c,e (M:1 T:4)
            // -- M1
            case 0x00C3: _rfsh(); break;
            // -- OVERLAP
            case 0x00C4: cpu->c=cpu->e;_fetch(); break;
            
            // 0x4C: ld c,h (M:1 T:4)
            // -- M1
            case 0x00C5: _rfsh(); break;
            // -- OVERLAP
            case 0x00C6: cpu->c=cpu->h;_fetch(); break;
            
            // 0x4D: ld c,l (M:1 T:4)
            // -- M1
            case 0x00C7: _rfsh(); break;
            // -- OVERLAP
            case 0x00C8: cpu->c=cpu->l;_fetch(); break;
            
            // 0x4E: ld c,(hl) (M:2 T:7)
            // -- M1
            case 0x00C9: _rfsh(); break;
            // -- M2
            case 0x00CA: _mread(cpu->hl); break;
            case 0x00CB: cpu->c=_gd(); break;
            // -- OVERLAP
            ...
            // -- OVERLAP
            case 0x00CE: cpu->c=cpu->a;_fetch(); break;
            
            // 0x50: ld d,b (M:1 T:4)
            // -- M1
            case 0x00CF: _rfsh(); break;
            // -- OVERLAP
            case 0x00D0: cpu->d=cpu->b;_fetch(); break;
            
            // 0x51: ld d,c (M:1 T:4)
            // -- M1
            case 0x00D1: _rfsh(); break;
            // -- OVERLAP
            case 0x00D2: cpu->d=cpu->c;_fetch(); break;
            
            // 0x52: ld d,d (M:1 T:4)
            // -- M1
            case 0x00D3: _rfsh(); break;
            // -- OVERLAP
            case 0x00D4: cpu->d=cpu->d;_fetch(); break;
            
            // 0x53: ld d,e (M:1 T:4)
            // -- M1
            case 0x00D5: _rfsh(); break;
            // -- OVERLAP
            case 0x00D6: cpu->d=cpu->e;_fetch(); break;
            
            // 0x54: ld d,h (M:1 T:4)
            // -- M1
            case 0x00D7: _rfsh(); break;
            // -- OVERLAP
            case 0x00D8: cpu->d=cpu->h;_fetch(); break;
            
            // 0x55: ld d,l (M:1 T:4)
            // -- M1
            case 0x00D9: _rfsh(); break;
            // -- OVERLAP
            case 0x00DA: cpu->d=cpu->l;_fetch(); break;
            
            // 0x56: ld d,(hl) (M:2 T:7)
            // -- M1
            case 0x00DB: _rfsh(); break;
            // -- M2
            case 0x00DC: _mread(cpu->hl); break;
            case 0x00DD: cpu->d=_gd(); break;
            // -- OVERLAP
            ...
            // -- OVERLAP
            case 0x00E0: cpu->d=cpu->a;_fetch(); break;
            
            // 0x58: ld e,b (M:1 T:4)
            // -- M1
            case 0x00E1: _rfsh(); break;
            // -- OVERLAP
            case 0x00E2: cpu->e=cpu->b;_fetch(); break;
            
            // 0x59: ld e,c (M:1 T:4)
            // -- M1
            case 0x00E3: _rfsh(); break;
            // -- OVERLAP
            case 0x00E4: cpu->e=cpu->c;_fetch(); break;
            
            // 0x5A: ld e,d (M:1 T:4)
            // -- M1
            case 0x00E5: _rfsh(); break;
            // -- OVERLAP
            case 0x00E6: cpu->e=cpu->d;_fetch(); break;
            
            // 0x5B: ld e,e (M:1 T:4)
            // -- M1
            case 0x00E7: _rfsh(); break;
            // -- OVERLAP
            case 0x00E8: cpu->e=cpu->e;_fetch(); break;
            
            // 0x5C: ld e,h (M:1 T:4)
            // -- M1
            case 0x00E9: _rfsh(); break;
            // -- OVERLAP
            case 0x00EA: cpu->e=cpu->h;_fetch(); break;
            
            // 0x5D: ld e,l (M:1 T:4)
            // -- M1
            case 0x00EB: _rfsh(); break;
            // -- OVERLAP
            case 0x00EC: cpu->e=cpu->l;_fetch(); break;
            
            // 0x5E: ld e,(hl) (M:2 T:7)
            // -- M1
            case 0x00ED: _rfsh(); break;
            // -- M2
            case 0x00EE: _mread(cpu->hl); break;
            case 0x00EF: cpu->e=_gd(); break;
            // -- OVERLAP
            case 0x00F0: _fetch(); break;
            
            // 0x5F: ld e,a (M:1 T:4)
            // -- M1
            case 0x00F1: _rfsh(); break;
            // -- OVERLAP
            case 0x00F2: cpu->e=cpu->a;_fetch(); break;
            
            // 0x60: ld h,b (M:1 T:4)
            // -- M1
            case 0x00F3: _rfsh(); break;
            // -- OVERLAP
            case 0x00F4: cpu->h=cpu->b;_fetch(); break;
            
            // 0x61: ld h,c (M:1 T:4)
            // -- M1
            case 0x00F5: _rfsh(); break;
            // -- OVERLAP
            case 0x00F6: cpu->h=cpu->c;_fetch(); break;
            
            // 0x62: ld h,d (M:1 T:4)
            // -- M1
            case 0x00F7: _rfsh(); break;
            // -- OVERLAP
            case 0x00F8: cpu->h=cpu->d;_fetch(); break;
            
            // 0x63: ld h,e (M:1 T:4)
            // -- M1
            case 0x00F9: _rfsh(); break;
            // -- OVERLAP
            case 0x00FA: cpu->h=cpu->e;_fetch(); break;
            
            // 0x64: ld h,h (M:1 T:4)
            // -- M1
            case 0x00FB: _rfsh(); break;
            // -- OVERLAP
            case 0x00FC: cpu->h=cpu->h;_fetch(); break;
            
            // 0x65: ld h,l (M:1 T:4)
            // -- M1
            case 0x00FD: _rfsh(); break;
            // -- OVERLAP
            case 0x00FE: cpu->h=cpu->l;_fetch(); break;
            
            // 0x66: ld h,(hl) (M:2 T:7)
            // -- M1
            case 0x00FF: _rfsh(); break;
            // -- M2
            case 0x0100: _mread(cpu->hl); break;
            case 0x0101: cpu->h=_gd(); break;
            // -- OVERLAP
            ...
            // -- OVERLAP
            case 0x0104: cpu->h=cpu->a;_fetch(); break;
            
            // 0x68: ld l,b (M:1 T:4)
            // -- M1
            case 0x0105: _rfsh(); break;
            // -- OVERLAP
            case 0x0106: cpu->l=cpu->b;_fetch(); break;
            
            // 0x69: ld l,c (M:1 T:4)
            // -- M1
            case 0x0107: _rfsh(); break;
            // -- OVERLAP
            case 0x0108: cpu->l=cpu->c;_fetch(); break;
            
            // 0x6A: ld l,d (M:1 T:4)
            // -- M1
            case 0x0109: _rfsh(); break;
            // -- OVERLAP
            case 0x010A: cpu->l=cpu->d;_fetch(); break;
            
            // 0x6B: ld l,e (M:1 T:4)
            // -- M1
            case 0x010B: _rfsh(); break;
            // -- OVERLAP
            case 0x010C: cpu->l=cpu->e;_fetch(); break;
            
            // 0x6C: ld l,h (M:1 T:4)
            // -- M1
            case 0x010D: _rfsh(); break;
            // -- OVERLAP
            case 0x010E: cpu->l=cpu->h;_fetch(); break;
            
            // 0x6D: ld l,l (M:1 T:4)
            // -- M1
            case 0x010F: _rfsh(); break;
            // -- OVERLAP
            case 0x0110: cpu->l=cpu->l;_fetch(); break;
            
            // 0x6E: ld l,(hl) (M:2 T:7)
            // -- M1
            case 0x0111: _rfsh(); break;
            // -- M2
            case 0x0112: _mread(cpu->hl); break;
            case 0x0113: cpu->l=_gd(); break;
            // -- OVERLAP
            case 0x0114: _fetch(); break;
            
            // 0x6F: ld l,a (M:1 T:4)
            // -- M1
            case 0x0115: _rfsh(); break;
            // -- OVERLAP
            case 0x0116: cpu->l=cpu->a;_fetch(); break;
            
            // 0x70: ld (hl),b (M:2 T:7)
            // -- M1
            case 0x0117: _rfsh(); break;
            // -- M2
            case 0x0118: _mwrite(cpu->hl,cpu->b); break;
            // -- OVERLAP
            ...
            // -- M2
            case 0x011B: _mwrite(cpu->hl,cpu->c); break;
            // -- OVERLAP
            ...
            // -- M2
            case 0x011E: _mwrite(cpu->hl,cpu->d); break;
            // -- OVERLAP
            ...
            // -- M2
            case 0x0121: _mwrite(cpu->hl,cpu->e); break;
            // -- OVERLAP
            case 0x0122: _fetch(); break;
            
            // 0x74: ld (hl),h (M:2 T:7)
            // -- M1
            case 0x0123: _rfsh(); break;
            // -- M2
            case 0x0124: _mwrite(cpu->hl,cpu->h); break;
            // -- OVERLAP
            ...
            // -- M2
            case 0x0127: _mwrite(cpu->hl,cpu->l); break;
            // -- OVERLAP
            ...
            // -- OVERLAP
            case 0x012A: z80_halt(cpu);_fetch(); break;
            
            // 0x77: ld (hl),a (M:2 T:7)
            // -- M1
            case 0x012B: _rfsh(); break;
            // -- M2
            case 0x012C: _mwrite(cpu->hl,cpu->a); break;
            // -- OVERLAP
            ...
            // -- OVERLAP
            case 0x012F: cpu->a=cpu->b;_fetch(); break;
            
            // 0x79: ld a,c (M:1 T:4)
            // -- M1
            case 0x0130: _rfsh(); break;
            // -- OVERLAP
            case 0x0131: cpu->a=cpu->c;_fetch(); break;
            
            // 0x7A: ld a,d (M:1 T:4)
            // -- M1
            case 0x0132: _rfsh(); break;
            // -- OVERLAP
            case 0x0133: cpu->a=cpu->d;_fetch(); break;
            
            // 0x7B: ld a,e (M:1 T:4)
            // -- M1
            case 0x0134: _rfsh(); break;
            // -- OVERLAP
            case 0x0135: cpu->a=cpu->e;_fetch(); break;
            
            // 0x7C: ld a,h (M:1 T:4)
            // -- M1
            case 0x0136: _rfsh(); break;
            // -- OVERLAP
            case 0x0137: cpu->a=cpu->h;_fetch(); break;
            
            // 0x7D: ld a,l (M:1 T:4)
            // -- M1
            case 0x0138: _rfsh(); break;
            // -- OVERLAP
            case 0x0139: cpu->a=cpu->l;_fetch(); break;
            
            // 0x7E: ld a,(hl) (M:2 T:7)
            // -- M1
            case 0x013A: _rfsh(); break;
            // -- M2
            case 0x013B: _mread(cpu->hl); break;
            case 0x013C: cpu->a=_gd(); break;
            // -- OVERLAP
            ...
            // -- OVERLAP
            case 0x013F: cpu->a=cpu->a;_fetch(); break;
            
            // 0x80: add b (M:1 T:4)
            // -- M1
            case 0x0140: _rfsh(); break;
            // -- OVERLAP
            case 0x0141: z80_add(cpu,cpu->b);_fetch(); break;
            
            // 0x81: add c (M:1 T:4)
            // -- M1
            case 0x0142: _rfsh(); break;
            // -- OVERLAP
            case 0x0143: z80_add(cpu,cpu->c);_fetch(); break;
            
            // 0x82: add d (M:1 T:4)
            // -- M1
            case 0x0144: _rfsh(); break;
            // -- OVERLAP
            case 0x0145: z80_add(cpu,cpu->d);_fetch(); break;
            
            // 0x83: add e (M:1 T:4)
            // -- M1
            case 0x0146: _rfsh(); break;
            // -- OVERLAP
            case 0x0147: z80_add(cpu,cpu->e);_fetch(); break;
            
            // 0x84: add h (M:1 T:4)
            // -- M1
            case 0x0148: _rfsh(); break;
            // -- OVERLAP
            case 0x0149: z80_add(cpu,cpu->h);_fetch(); break;
            
            // 0x85: add l (M:1 T:4)
            // -- M1
            case 0x014A: _rfsh(); break;
            // -- OVERLAP
            case 0x014B: z80_add(cpu,cpu->l);_fetch(); break;
            
            // 0x86: add (hl) (M:2 T:7)
            // -- M1
            case 0x014C: _rfsh(); break;
            // -- M2
            case 0x014D: _mread(cpu->hl); break;
            case 0x014E: cpu->dlatch=_gd(); break;
            // -- OVERLAP
            case 0x014F: z80_add(cpu,cpu->dlatch);_fetch(); break;
            
            // 0x87: add a (M:1 T:4)
            // -- M1
            case 0x0150: _rfsh(); break;
            // -- OVERLAP
            case 0x0151: z80_add(cpu,cpu->a);_fetch(); break;
            
            // 0x88: adc b (M:1 T:4)
            // -- M1
            case 0x0152: _rfsh(); break;
            // -- OVERLAP
            case 0x0153: z80_adc(cpu,cpu->b);_fetch(); break;
            
            // 0x89: adc c (M:1 T:4)
            // -- M1
            case 0x0154: _rfsh(); break;
            // -- OVERLAP
            case 0x0155: z80_adc(cpu,cpu->c);_fetch(); break;
            
            // 0x8A: adc d (M:1 T:4)
            // -- M1
            case 0x0156: _rfsh(); break;
            // -- OVERLAP
            case 0x0157: z80_adc(cpu,cpu->d);_fetch(); break;
            
            // 0x8B: adc e (M:1 T:4)
            // -- M1
            case 0x0158: _rfsh(); break;
            // -- OVERLAP
            case 0x0159: z80_adc(cpu,cpu->e);_fetch(); break;
            
            // 0x8C: adc h (M:1 T:4)
            // -- M1
            case 0x015A: _rfsh(); break;
            // -- OVERLAP
            case 0x015B: z80_adc(cpu,cpu->h);_fetch(); break;
            
            // 0x8D: adc l (M:1 T:4)
            // -- M1
            case 0x015C: _rfsh(); break;
            // -- OVERLAP
            case 0x015D: z80_adc(cpu,cpu->l);_fetch(); break;
            
            // 0x8E: adc (hl) (M:2 T:7)
            // -- M1
            case 0x015E: _rfsh(); break;
            // -- M2
            case 0x015F: _mread(cpu->hl); break;
            case 0x0160: cpu->dlatch=_gd(); break;
            // -- OVERLAP
            case 0x0161: z80_adc(cpu,cpu->dlatch);_fetch(); break;
            
            // 0x8F: adc a (M:1 T:4)
            // -- M1
            case 0x0162: _rfsh(); break;
            // -- OVERLAP
            case 0x0163: z80_adc(cpu,cpu->a);_fetch(); break;
            
            // 0x90: sub b (M:1 T:4)
            // -- M1
            case 0x0164: _rfsh(); break;
            // -- OVERLAP
            case 0x0165: z80_sub(cpu,cpu->b);_fetch(); break;
            
            // 0x91: sub c (M:1 T:4)
            // -- M1
            case 0x0166: _rfsh(); break;
            // -- OVERLAP
            case 0x0167: z80_sub(cpu,cpu->c);_fetch(); break;
            
            // 0x92: sub d (M:1 T:4)
            // -- M1
            case 0x0168: _rfsh(); break;
            // -- OVERLAP
            case 0x0169: z80_sub(cpu,cpu->d);_fetch(); break;
            
            // 0x93: sub e (M:1 T:4)
            // -- M1
            case 0x016A: _rfsh(); break;
            // -- OVERLAP
            case 0x016B: z80_sub(cpu,cpu->e);_fetch(); break;
            
            // 0x94: sub h (M:1 T:4)
            // -- M1
            case 0x016C: _rfsh(); break;
            // -- OVERLAP
            case 0x016D: z80_sub(cpu,cpu->h);_fetch(); break;
            
            // 0x95: sub l (M:1 T:4)
            // -- M1
            case 0x016E: _rfsh(); break;
            // -- OVERLAP
            case 0x016F: z80_sub(cpu,cpu->l);_fetch(); break;
            
            // 0x96: sub (hl) (M:2 T:7)
            // -- M1
            case 0x0170: _rfsh(); break;
            // -- M2
            case 0x0171: _mread(cpu->hl); break;
            case 0x0172: cpu->dlatch=_gd(); break;
            // -- OVERLAP
            case 0x0173: z80_sub(cpu,cpu->dlatch);_fetch(); break;
            
            // 0x97: sub a (M:1 T:4)
            // -- M1
            case 0x0174: _rfsh(); break;
            // -- OVERLAP
            case 0x0175: z80_sub(cpu,cpu->a);_fetch(); break;
            
            // 0x98: sbc b (M:1 T:4)
            // -- M1
            case 0x0176: _rfsh(); break;
            // -- OVERLAP
            case 0x0177: z80_sbc(cpu,cpu->b);_fetch(); break;
            
            // 0x99: sbc c (M:1 T:4)
            // -- M1
            case 0x0178: _rfsh(); break;
            // -- OVERLAP
            case 0x0179: z80_sbc(cpu,cpu->c);_fetch(); break;
            
            // 0x9A: sbc d (M:1 T:4)
            // -- M1
            case 0x017A: _rfsh(); break;
            // -- OVERLAP
            case 0x017B: z80_sbc(cpu,cpu->d);_fetch(); break;
            
            // 0x9B: sbc e (M:1 T:4)
            // -- M1
            case 0x017C: _rfsh(); break;
            // -- OVERLAP
            case 0x017D: z80_sbc(cpu,cpu->e);_fetch(); break;
            
            // 0x9C: sbc h (M:1 T:4)
            // -- M1
            case 0x017E: _rfsh(); break;
            // -- OVERLAP
            case 0x017F: z80_sbc(cpu,cpu->h);_fetch(); break;
            
            // 0x9D: sbc l (M:1 T:4)
            // -- M1
            case 0x0180: _rfsh(); break;
            // -- OVERLAP
            case 0x0181: z80_sbc(cpu,cpu->l);_fetch(); break;
            
            // 0x9E: sbc (hl) (M:2 T:7)
            // -- M1
            case 0x0182: _rfsh(); break;
            // -- M2
            case 0x0183: _mread(cpu->hl); break;
            case 0x0184: cpu->dlatch=_gd(); break;
            // -- OVERLAP
            case 0x0185: z80_sbc(cpu,cpu->dlatch);_fetch(); break;
            
            // 0x9F: sbc a (M:1 T:4)
            // -- M1
            case 0x0186: _rfsh(); break;
            // -- OVERLAP
            case 0x0187: z80_sbc(cpu,cpu->a);_fetch(); break;
            
            // 0xA0: and b (M:1 T:4)
            // -- M1
            case 0x0188: _rfsh(); break;
            // -- OVERLAP
            case 0x0189: z80_and(cpu,cpu->b);_fetch(); break;
            
            // 0xA1: and c (M:1 T:4)
            // -- M1
            case 0x018A: _rfsh(); break;
            // -- OVERLAP
            case 0x018B: z80_and(cpu,cpu->c);_fetch(); break;
            
            // 0xA2: and d (M:1 T:4)
            // -- M1
            case 0x018C: _rfsh(); break;
            // -- OVERLAP
            case 0x018D: z80_and(cpu,cpu->d);_fetch(); break;
            
            // 0xA3: and e (M:1 T:4)
            // -- M1
            case 0x018E: _rfsh(); break;
            // -- OVERLAP
            case 0x018F: z80_and(cpu,cpu->e);_fetch(); break;
            
            // 0xA4: and h (M:1 T:4)
            // -- M1
            case 0x0190: _rfsh(); break;
            // -- OVERLAP
            case 0x0191: z80_and(cpu,cpu->h);_fetch(); break;
            
            // 0xA5: and l (M:1 T:4)
            // -- M1
            case 0x0192: _rfsh(); break;
            // -- OVERLAP
            case 0x0193: z80_and(cpu,cpu->l);_fetch(); break;
            
            // 0xA6: and (hl) (M:2 T:7)
            // -- M1
            case 0x0194: _rfsh(); break;
            // -- M2
            case 0x0195: _mread(cpu->hl); break;
            case 0x0196: cpu->dlatch=_gd(); break;
            // -- OVERLAP
            case 0x0197: z80_and(cpu,cpu->dlatch);_fetch(); break;
            
            // 0xA7: and a (M:1 T:4)
            // -- M1
            case 0x0198: _rfsh(); break;
            // -- OVERLAP
            case 0x0199: z80_and(cpu,cpu->a);_fetch(); break;
            
            // 0xA8: xor b (M:1 T:4)
            // -- M1
            case 0x019A: _rfsh(); break;
            // -- OVERLAP
            case 0x019B: z80_xor(cpu,cpu->b);_fetch(); break;
            
            // 0xA9: xor c (M:1 T:4)
            // -- M1
            case 0x019C: _rfsh(); break;
            // -- OVERLAP
            case 0x019D: z80_xor(cpu,cpu->c);_fetch(); break;
            
            // 0xAA: xor d (M:1 T:4)
            // -- M1
            case 0x019E: _rfsh(); break;
            // -- OVERLAP
            case 0x019F: z80_xor(cpu,cpu->d);_fetch(); break;
            
            // 0xAB: xor e (M:1 T:4)
            // -- M1
            case 0x01A0: _rfsh(); break;
            // -- OVERLAP
            case 0x01A1: z80_xor(cpu,cpu->e);_fetch(); break;
            
            // 0xAC: xor h (M:1 T:4)
            // -- M1
            case 0x01A2: _rfsh(); break;
            // -- OVERLAP
            case 0x01A3: z80_xor(cpu,cpu->h);_fetch(); break;
            
            // 0xAD: xor l (M:1 T:4)
            // -- M1
            case 0x01A4: _rfsh(); break;
            // -- OVERLAP
            case 0x01A5: z80_xor(cpu,cpu->l);_fetch(); break;
            
            // 0xAE: xor (hl) (M:2 T:7)
            // -- M1
            case 0x01A6: _rfsh(); break;
            // -- M2
            case 0x01A7: _mread(cpu->hl); break;
            case 0x01A8: cpu->dlatch=_gd(); break;
            // -- OVERLAP
            case 0x01A9: z80_xor(cpu,cpu->dlatch);_fetch(); break;
            
            // 0xAF: xor a (M:1 T:4)
            // -- M1
            case 0x01AA: _rfsh(); break;
            // -- OVERLAP
            case 0x01AB: z80_xor(cpu,cpu->a);_fetch(); break;
            
            // 0xB0: or b (M:1 T:4)
            // -- M1
            case 0x01AC: _rfsh(); break;
            // -- OVERLAP
            case 0x01AD: z80_or(cpu,cpu->b);_fetch(); break;
            
            // 0xB1: or c (M:1 T:4)
            // -- M1
            case 0x01AE: _rfsh(); break;
            // -- OVERLAP
            case 0x01AF: z80_or(cpu,cpu->c);_fetch(); break;
            
            // 0xB2: or d (M:1 T:4)
            // -- M1
            case 0x01B0: _rfsh(); break;
            // -- OVERLAP
            case 0x01B1: z80_or(cpu,cpu->d);_fetch(); break;
            
            // 0xB3: or e (M:1 T:4)
            // -- M1
            case 0x01B2: _rfsh(); break;
            // -- OVERLAP
            case 0x01B3: z80_or(cpu,cpu->e);_fetch(); break;
            
            // 0xB4: or h (M:1 T:4)
            // -- M1
            case 0x01B4: _rfsh(); break;
            // -- OVERLAP
            case 0x01B5: z80_or(cpu,cpu->h);_fetch(); break;
            
            // 0xB5: or l (M:1 T:4)
            // -- M1
            case 0x01B6: _rfsh(); break;
            // -- OVERLAP
            case 0x01B7: z80_or(cpu,cpu->l);_fetch(); break;
            
            // 0xB6: or (hl) (M:2 T:7)
            // -- M1
            case 0x01B8: _rfsh(); break;
            // -- M2
            case 0x01B9: _mread(cpu->hl); break;
            case 0x01BA: cpu->dlatch=_gd(); break;
            // -- OVERLAP
            case 0x01BB: z80_or(cpu,cpu->dlatch);_fetch(); break;
            
            // 0xB7: or a (M:1 T:4)
            // -- M1
            case 0x01BC: _rfsh(); break;
            // -- OVERLAP
            case 0x01BD: z80_or(cpu,cpu->a);_fetch(); break;
            
            // 0xB8: cp b (M:1 T:4)
            // -- M1
            case 0x01BE: _rfsh(); break;
            // -- OVERLAP
            case 0x01BF: z80_cp(cpu,cpu->b);_fetch(); break;
            
            // 0xB9: cp c (M:1 T:4)
            // -- M1
            case 0x01C0: _rfsh(); break;
            // -- OVERLAP
            case 0x01C1: z80_cp(cpu,cpu->c);_fetch(); break;
            
            // 0xBA: cp d (M:1 T:4)
            // -- M1
            case 0x01C2: _rfsh(); break;
            // -- OVERLAP
            case 0x01C3: z80_cp(cpu,cpu->d);_fetch(); break;
            
            // 0xBB: cp e (M:1 T:4)
            // -- M1
            case 0x01C4: _rfsh(); break;
            // -- OVERLAP
            case 0x01C5: z80_cp(cpu,cpu->e);_fetch(); break;
            
            // 0xBC: cp h (M:1 T:4)
            // -- M1
            case 0x01C6: _rfsh(); break;
            // -- OVERLAP
            case 0x01C7: z80_cp(cpu,cpu->h);_fetch(); break;
            
            // 0xBD: cp l (M:1 T:4)
            // -- M1
            case 0x01C8: _rfsh(); break;
            // -- OVERLAP
            case 0x01C9: z80_cp(cpu,cpu->l);_fetch(); break;
            
            // 0xBE: cp (hl) (M:2 T:7)
            // -- M1
            case 0x01CA: _rfsh(); break;
            // -- M2
            case 0x01CB: _mread(cpu->hl); break;
            case 0x01CC: cpu->dlatch=_gd(); break;
            // -- OVERLAP
            case 0x01CD: z80_cp(cpu,cpu->dlatch);_fetch(); break;
            
            // 0xBF: cp a (M:1 T:4)
            // -- M1
            case 0x01CE: _rfsh(); break;
            // -- OVERLAP
            case 0x01CF: z80_cp(cpu,cpu->a);_fetch(); break;
            ...
            // 0xFB: ei (M:1 T:4)
            // -- M1
            case 0x0246: _rfsh(); break;
            // -- OVERLAP
            case 0x0247: _fetch(); break;
            
            // 0xFC: call m,nn (M:1 T:4)
            // -- M1
            case 0x0248: _rfsh(); break;
            // -- OVERLAP
            case 0x0249: _fetch(); break;
            
            // 0xFD: fd prefix (M:1 T:4)
            // -- M1
            case 0x024A: _rfsh(); break;
            // -- OVERLAP
            case 0x024B: _fetch(); break;
            
            // 0xFE: cp n (M:1 T:4)
            // -- M1
            case 0x024C: _rfsh(); break;
            // -- OVERLAP
            case 0x024D: _fetch(); break;
            
            // 0xFF: rst 38h (M:1 T:4)
            // -- M1
            case 0x024E: _rfsh(); break;
            // -- OVERLAP
            case 0x024F: _fetch(); break;
