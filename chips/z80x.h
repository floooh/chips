...
static const z80_opstate_t z80_opstate_table[2*256 + 3] = {
    ...
    { 0x0000000A, 0x000F, 0 },  //  03: inc bc (M:2 T:6 steps:2)
    { 0x00000002, 0x0011, 0 },  //  04: inc b (M:1 T:4 steps:1)
    { 0x00000002, 0x0012, 0 },  //  05: dec b (M:1 T:4 steps:1)
    { 0x00000016, 0x0013, Z80_OPSTATE_FLAGS_IMM8 },  //  06: ld b,n (M:2 T:7 steps:3)
    { 0x00000002, 0x0016, 0 },  //  07: rlca (M:1 T:4 steps:1)
    { 0x00000002, 0x0017, 0 },  //  08: ex af,af' (M:1 T:4 steps:1)
    { 0x00000102, 0x0018, 0 },  //  09: add hl,bc (M:2 T:11 steps:2)
    { 0x00000016, 0x001A, 0 },  //  0A: ld a,(bc) (M:2 T:7 steps:3)
    { 0x0000000A, 0x001D, 0 },  //  0B: dec bc (M:2 T:6 steps:2)
    { 0x00000002, 0x001F, 0 },  //  0C: inc c (M:1 T:4 steps:1)
    { 0x00000002, 0x0020, 0 },  //  0D: dec c (M:1 T:4 steps:1)
    { 0x00000016, 0x0021, Z80_OPSTATE_FLAGS_IMM8 },  //  0E: ld c,n (M:2 T:7 steps:3)
    { 0x00000002, 0x0024, 0 },  //  0F: rrca (M:1 T:4 steps:1)
    { 0x0000042C, 0x0025, 0 },  //  10: djnz d (M:3 T:13 steps:4)
    { 0x000000B6, 0x0029, 0 },  //  11: ld de,nn (M:3 T:10 steps:5)
    { 0x0000001C, 0x002E, 0 },  //  12: ld (de),a (M:2 T:7 steps:3)
    { 0x0000000A, 0x0031, 0 },  //  13: inc de (M:2 T:6 steps:2)
    { 0x00000002, 0x0033, 0 },  //  14: inc d (M:1 T:4 steps:1)
    { 0x00000002, 0x0034, 0 },  //  15: dec d (M:1 T:4 steps:1)
    { 0x00000016, 0x0035, Z80_OPSTATE_FLAGS_IMM8 },  //  16: ld d,n (M:2 T:7 steps:3)
    { 0x00000002, 0x0038, 0 },  //  17: rla (M:1 T:4 steps:1)
    { 0x00000216, 0x0039, 0 },  //  18: jr d (M:3 T:12 steps:4)
    { 0x00000102, 0x003D, 0 },  //  19: add hl,de (M:2 T:11 steps:2)
    { 0x00000016, 0x003F, 0 },  //  1A: ld a,(de) (M:2 T:7 steps:3)
    { 0x0000000A, 0x0042, 0 },  //  1B: dec de (M:2 T:6 steps:2)
    { 0x00000002, 0x0044, 0 },  //  1C: inc e (M:1 T:4 steps:1)
    { 0x00000002, 0x0045, 0 },  //  1D: dec e (M:1 T:4 steps:1)
    { 0x00000016, 0x0046, Z80_OPSTATE_FLAGS_IMM8 },  //  1E: ld e,n (M:2 T:7 steps:3)
    { 0x00000002, 0x0049, 0 },  //  1F: rra (M:1 T:4 steps:1)
    { 0x00000216, 0x004A, 0 },  //  20: jr nz,d (M:3 T:12 steps:4)
    { 0x000000B6, 0x004E, 0 },  //  21: ld hl,nn (M:3 T:10 steps:5)
    { 0x00003B36, 0x0053, 0 },  //  22: ld (nn),hl (M:5 T:16 steps:9)
    { 0x0000000A, 0x005C, 0 },  //  23: inc hl (M:2 T:6 steps:2)
    { 0x00000002, 0x005E, 0 },  //  24: inc h (M:1 T:4 steps:1)
    { 0x00000002, 0x005F, 0 },  //  25: dec h (M:1 T:4 steps:1)
    { 0x00000016, 0x0060, Z80_OPSTATE_FLAGS_IMM8 },  //  26: ld h,n (M:2 T:7 steps:3)
    { 0x00000002, 0x0063, 0 },  //  27: daa (M:1 T:4 steps:1)
    { 0x00000216, 0x0064, 0 },  //  28: jr z,d (M:3 T:12 steps:4)
    { 0x00000102, 0x0068, 0 },  //  29: add hl,hl (M:2 T:11 steps:2)
    { 0x00002DB6, 0x006A, 0 },  //  2A: ld hl,(nn) (M:5 T:16 steps:9)
    { 0x0000000A, 0x0073, 0 },  //  2B: dec hl (M:2 T:6 steps:2)
    { 0x00000002, 0x0075, 0 },  //  2C: inc l (M:1 T:4 steps:1)
    { 0x00000002, 0x0076, 0 },  //  2D: dec l (M:1 T:4 steps:1)
    { 0x00000016, 0x0077, Z80_OPSTATE_FLAGS_IMM8 },  //  2E: ld l,n (M:2 T:7 steps:3)
    { 0x00000002, 0x007A, 0 },  //  2F: cpl (M:1 T:4 steps:1)
    { 0x00000216, 0x007B, 0 },  //  30: jr nc,d (M:3 T:12 steps:4)
    { 0x000000B6, 0x007F, 0 },  //  31: ld sp,nn (M:3 T:10 steps:5)
    { 0x00000736, 0x0084, 0 },  //  32: ld (nn),a (M:4 T:13 steps:7)
    { 0x0000000A, 0x008B, 0 },  //  33: inc sp (M:2 T:6 steps:2)
    { 0x000001C6, 0x008D, Z80_OPSTATE_FLAGS_INDIRECT },  //  34: inc (hl) (M:3 T:11 steps:5)
    { 0x000001C6, 0x0092, Z80_OPSTATE_FLAGS_INDIRECT },  //  35: dec (hl) (M:3 T:11 steps:5)
    { 0x000000E6, 0x0097, Z80_OPSTATE_FLAGS_INDIRECT|Z80_OPSTATE_FLAGS_IMM8 },  //  36: ld (hl),n (M:3 T:10 steps:5)
    { 0x00000002, 0x009C, 0 },  //  37: scf (M:1 T:4 steps:1)
    { 0x00000216, 0x009D, 0 },  //  38: jr c,d (M:3 T:12 steps:4)
    { 0x00000102, 0x00A1, 0 },  //  39: add hl,sp (M:2 T:11 steps:2)
    { 0x000005B6, 0x00A3, 0 },  //  3A: ld a,(nn) (M:4 T:13 steps:7)
    { 0x0000000A, 0x00AA, 0 },  //  3B: dec sp (M:2 T:6 steps:2)
    { 0x00000002, 0x00AC, 0 },  //  3C: inc a (M:1 T:4 steps:1)
    { 0x00000002, 0x00AD, 0 },  //  3D: dec a (M:1 T:4 steps:1)
    { 0x00000016, 0x00AE, Z80_OPSTATE_FLAGS_IMM8 },  //  3E: ld a,n (M:2 T:7 steps:3)
    { 0x00000002, 0x00B1, 0 },  //  3F: ccf (M:1 T:4 steps:1)
    { 0x00000002, 0x00B2, 0 },  //  40: ld b,b (M:1 T:4 steps:1)
    { 0x00000002, 0x00B3, 0 },  //  41: ld b,c (M:1 T:4 steps:1)
    { 0x00000002, 0x00B4, 0 },  //  42: ld b,d (M:1 T:4 steps:1)
    { 0x00000002, 0x00B5, 0 },  //  43: ld b,e (M:1 T:4 steps:1)
    { 0x00000002, 0x00B6, 0 },  //  44: ld b,h (M:1 T:4 steps:1)
    { 0x00000002, 0x00B7, 0 },  //  45: ld b,l (M:1 T:4 steps:1)
    { 0x00000016, 0x00B8, Z80_OPSTATE_FLAGS_INDIRECT },  //  46: ld b,(hl) (M:2 T:7 steps:3)
    { 0x00000002, 0x00BB, 0 },  //  47: ld b,a (M:1 T:4 steps:1)
    { 0x00000002, 0x00BC, 0 },  //  48: ld c,b (M:1 T:4 steps:1)
    { 0x00000002, 0x00BD, 0 },  //  49: ld c,c (M:1 T:4 steps:1)
    { 0x00000002, 0x00BE, 0 },  //  4A: ld c,d (M:1 T:4 steps:1)
    { 0x00000002, 0x00BF, 0 },  //  4B: ld c,e (M:1 T:4 steps:1)
    { 0x00000002, 0x00C0, 0 },  //  4C: ld c,h (M:1 T:4 steps:1)
    { 0x00000002, 0x00C1, 0 },  //  4D: ld c,l (M:1 T:4 steps:1)
    { 0x00000016, 0x00C2, Z80_OPSTATE_FLAGS_INDIRECT },  //  4E: ld c,(hl) (M:2 T:7 steps:3)
    { 0x00000002, 0x00C5, 0 },  //  4F: ld c,a (M:1 T:4 steps:1)
    { 0x00000002, 0x00C6, 0 },  //  50: ld d,b (M:1 T:4 steps:1)
    { 0x00000002, 0x00C7, 0 },  //  51: ld d,c (M:1 T:4 steps:1)
    { 0x00000002, 0x00C8, 0 },  //  52: ld d,d (M:1 T:4 steps:1)
    { 0x00000002, 0x00C9, 0 },  //  53: ld d,e (M:1 T:4 steps:1)
    { 0x00000002, 0x00CA, 0 },  //  54: ld d,h (M:1 T:4 steps:1)
    { 0x00000002, 0x00CB, 0 },  //  55: ld d,l (M:1 T:4 steps:1)
    { 0x00000016, 0x00CC, Z80_OPSTATE_FLAGS_INDIRECT },  //  56: ld d,(hl) (M:2 T:7 steps:3)
    { 0x00000002, 0x00CF, 0 },  //  57: ld d,a (M:1 T:4 steps:1)
    { 0x00000002, 0x00D0, 0 },  //  58: ld e,b (M:1 T:4 steps:1)
    { 0x00000002, 0x00D1, 0 },  //  59: ld e,c (M:1 T:4 steps:1)
    { 0x00000002, 0x00D2, 0 },  //  5A: ld e,d (M:1 T:4 steps:1)
    { 0x00000002, 0x00D3, 0 },  //  5B: ld e,e (M:1 T:4 steps:1)
    { 0x00000002, 0x00D4, 0 },  //  5C: ld e,h (M:1 T:4 steps:1)
    { 0x00000002, 0x00D5, 0 },  //  5D: ld e,l (M:1 T:4 steps:1)
    { 0x00000016, 0x00D6, Z80_OPSTATE_FLAGS_INDIRECT },  //  5E: ld e,(hl) (M:2 T:7 steps:3)
    { 0x00000002, 0x00D9, 0 },  //  5F: ld e,a (M:1 T:4 steps:1)
    { 0x00000002, 0x00DA, 0 },  //  60: ld h,b (M:1 T:4 steps:1)
    { 0x00000002, 0x00DB, 0 },  //  61: ld h,c (M:1 T:4 steps:1)
    { 0x00000002, 0x00DC, 0 },  //  62: ld h,d (M:1 T:4 steps:1)
    { 0x00000002, 0x00DD, 0 },  //  63: ld h,e (M:1 T:4 steps:1)
    { 0x00000002, 0x00DE, 0 },  //  64: ld h,h (M:1 T:4 steps:1)
    { 0x00000002, 0x00DF, 0 },  //  65: ld h,l (M:1 T:4 steps:1)
    { 0x00000016, 0x00E0, Z80_OPSTATE_FLAGS_INDIRECT },  //  66: ld h,(hl) (M:2 T:7 steps:3)
    { 0x00000002, 0x00E3, 0 },  //  67: ld h,a (M:1 T:4 steps:1)
    { 0x00000002, 0x00E4, 0 },  //  68: ld l,b (M:1 T:4 steps:1)
    { 0x00000002, 0x00E5, 0 },  //  69: ld l,c (M:1 T:4 steps:1)
    { 0x00000002, 0x00E6, 0 },  //  6A: ld l,d (M:1 T:4 steps:1)
    { 0x00000002, 0x00E7, 0 },  //  6B: ld l,e (M:1 T:4 steps:1)
    { 0x00000002, 0x00E8, 0 },  //  6C: ld l,h (M:1 T:4 steps:1)
    { 0x00000002, 0x00E9, 0 },  //  6D: ld l,l (M:1 T:4 steps:1)
    { 0x00000016, 0x00EA, Z80_OPSTATE_FLAGS_INDIRECT },  //  6E: ld l,(hl) (M:2 T:7 steps:3)
    { 0x00000002, 0x00ED, 0 },  //  6F: ld l,a (M:1 T:4 steps:1)
    { 0x0000001C, 0x00EE, Z80_OPSTATE_FLAGS_INDIRECT },  //  70: ld (hl),b (M:2 T:7 steps:3)
    { 0x0000001C, 0x00F1, Z80_OPSTATE_FLAGS_INDIRECT },  //  71: ld (hl),c (M:2 T:7 steps:3)
    { 0x0000001C, 0x00F4, Z80_OPSTATE_FLAGS_INDIRECT },  //  72: ld (hl),d (M:2 T:7 steps:3)
    { 0x0000001C, 0x00F7, Z80_OPSTATE_FLAGS_INDIRECT },  //  73: ld (hl),e (M:2 T:7 steps:3)
    { 0x0000001C, 0x00FA, Z80_OPSTATE_FLAGS_INDIRECT },  //  74: ld (hl),h (M:2 T:7 steps:3)
    { 0x0000001C, 0x00FD, Z80_OPSTATE_FLAGS_INDIRECT },  //  75: ld (hl),l (M:2 T:7 steps:3)
    { 0x00000002, 0x0100, 0 },  //  76: halt (M:1 T:4 steps:1)
    { 0x0000001C, 0x0101, Z80_OPSTATE_FLAGS_INDIRECT },  //  77: ld (hl),a (M:2 T:7 steps:3)
    { 0x00000002, 0x0104, 0 },  //  78: ld a,b (M:1 T:4 steps:1)
    { 0x00000002, 0x0105, 0 },  //  79: ld a,c (M:1 T:4 steps:1)
    { 0x00000002, 0x0106, 0 },  //  7A: ld a,d (M:1 T:4 steps:1)
    { 0x00000002, 0x0107, 0 },  //  7B: ld a,e (M:1 T:4 steps:1)
    { 0x00000002, 0x0108, 0 },  //  7C: ld a,h (M:1 T:4 steps:1)
    { 0x00000002, 0x0109, 0 },  //  7D: ld a,l (M:1 T:4 steps:1)
    { 0x00000016, 0x010A, Z80_OPSTATE_FLAGS_INDIRECT },  //  7E: ld a,(hl) (M:2 T:7 steps:3)
    { 0x00000002, 0x010D, 0 },  //  7F: ld a,a (M:1 T:4 steps:1)
    { 0x00000002, 0x010E, 0 },  //  80: add b (M:1 T:4 steps:1)
    { 0x00000002, 0x010F, 0 },  //  81: add c (M:1 T:4 steps:1)
    { 0x00000002, 0x0110, 0 },  //  82: add d (M:1 T:4 steps:1)
    { 0x00000002, 0x0111, 0 },  //  83: add e (M:1 T:4 steps:1)
    { 0x00000002, 0x0112, 0 },  //  84: add h (M:1 T:4 steps:1)
    { 0x00000002, 0x0113, 0 },  //  85: add l (M:1 T:4 steps:1)
    { 0x00000016, 0x0114, Z80_OPSTATE_FLAGS_INDIRECT },  //  86: add (hl) (M:2 T:7 steps:3)
    { 0x00000002, 0x0117, 0 },  //  87: add a (M:1 T:4 steps:1)
    { 0x00000002, 0x0118, 0 },  //  88: adc b (M:1 T:4 steps:1)
    { 0x00000002, 0x0119, 0 },  //  89: adc c (M:1 T:4 steps:1)
    { 0x00000002, 0x011A, 0 },  //  8A: adc d (M:1 T:4 steps:1)
    { 0x00000002, 0x011B, 0 },  //  8B: adc e (M:1 T:4 steps:1)
    { 0x00000002, 0x011C, 0 },  //  8C: adc h (M:1 T:4 steps:1)
    { 0x00000002, 0x011D, 0 },  //  8D: adc l (M:1 T:4 steps:1)
    { 0x00000016, 0x011E, Z80_OPSTATE_FLAGS_INDIRECT },  //  8E: adc (hl) (M:2 T:7 steps:3)
    { 0x00000002, 0x0121, 0 },  //  8F: adc a (M:1 T:4 steps:1)
    { 0x00000002, 0x0122, 0 },  //  90: sub b (M:1 T:4 steps:1)
    { 0x00000002, 0x0123, 0 },  //  91: sub c (M:1 T:4 steps:1)
    { 0x00000002, 0x0124, 0 },  //  92: sub d (M:1 T:4 steps:1)
    { 0x00000002, 0x0125, 0 },  //  93: sub e (M:1 T:4 steps:1)
    { 0x00000002, 0x0126, 0 },  //  94: sub h (M:1 T:4 steps:1)
    { 0x00000002, 0x0127, 0 },  //  95: sub l (M:1 T:4 steps:1)
    { 0x00000016, 0x0128, Z80_OPSTATE_FLAGS_INDIRECT },  //  96: sub (hl) (M:2 T:7 steps:3)
    { 0x00000002, 0x012B, 0 },  //  97: sub a (M:1 T:4 steps:1)
    { 0x00000002, 0x012C, 0 },  //  98: sbc b (M:1 T:4 steps:1)
    { 0x00000002, 0x012D, 0 },  //  99: sbc c (M:1 T:4 steps:1)
    { 0x00000002, 0x012E, 0 },  //  9A: sbc d (M:1 T:4 steps:1)
    { 0x00000002, 0x012F, 0 },  //  9B: sbc e (M:1 T:4 steps:1)
    { 0x00000002, 0x0130, 0 },  //  9C: sbc h (M:1 T:4 steps:1)
    { 0x00000002, 0x0131, 0 },  //  9D: sbc l (M:1 T:4 steps:1)
    { 0x00000016, 0x0132, Z80_OPSTATE_FLAGS_INDIRECT },  //  9E: sbc (hl) (M:2 T:7 steps:3)
    { 0x00000002, 0x0135, 0 },  //  9F: sbc a (M:1 T:4 steps:1)
    { 0x00000002, 0x0136, 0 },  //  A0: and b (M:1 T:4 steps:1)
    { 0x00000002, 0x0137, 0 },  //  A1: and c (M:1 T:4 steps:1)
    { 0x00000002, 0x0138, 0 },  //  A2: and d (M:1 T:4 steps:1)
    { 0x00000002, 0x0139, 0 },  //  A3: and e (M:1 T:4 steps:1)
    { 0x00000002, 0x013A, 0 },  //  A4: and h (M:1 T:4 steps:1)
    { 0x00000002, 0x013B, 0 },  //  A5: and l (M:1 T:4 steps:1)
    { 0x00000016, 0x013C, Z80_OPSTATE_FLAGS_INDIRECT },  //  A6: and (hl) (M:2 T:7 steps:3)
    { 0x00000002, 0x013F, 0 },  //  A7: and a (M:1 T:4 steps:1)
    { 0x00000002, 0x0140, 0 },  //  A8: xor b (M:1 T:4 steps:1)
    { 0x00000002, 0x0141, 0 },  //  A9: xor c (M:1 T:4 steps:1)
    { 0x00000002, 0x0142, 0 },  //  AA: xor d (M:1 T:4 steps:1)
    { 0x00000002, 0x0143, 0 },  //  AB: xor e (M:1 T:4 steps:1)
    { 0x00000002, 0x0144, 0 },  //  AC: xor h (M:1 T:4 steps:1)
    { 0x00000002, 0x0145, 0 },  //  AD: xor l (M:1 T:4 steps:1)
    { 0x00000016, 0x0146, Z80_OPSTATE_FLAGS_INDIRECT },  //  AE: xor (hl) (M:2 T:7 steps:3)
    { 0x00000002, 0x0149, 0 },  //  AF: xor a (M:1 T:4 steps:1)
    { 0x00000002, 0x014A, 0 },  //  B0: or b (M:1 T:4 steps:1)
    { 0x00000002, 0x014B, 0 },  //  B1: or c (M:1 T:4 steps:1)
    { 0x00000002, 0x014C, 0 },  //  B2: or d (M:1 T:4 steps:1)
    { 0x00000002, 0x014D, 0 },  //  B3: or e (M:1 T:4 steps:1)
    { 0x00000002, 0x014E, 0 },  //  B4: or h (M:1 T:4 steps:1)
    { 0x00000002, 0x014F, 0 },  //  B5: or l (M:1 T:4 steps:1)
    { 0x00000016, 0x0150, Z80_OPSTATE_FLAGS_INDIRECT },  //  B6: or (hl) (M:2 T:7 steps:3)
    { 0x00000002, 0x0153, 0 },  //  B7: or a (M:1 T:4 steps:1)
    { 0x00000002, 0x0154, 0 },  //  B8: cp b (M:1 T:4 steps:1)
    { 0x00000002, 0x0155, 0 },  //  B9: cp c (M:1 T:4 steps:1)
    { 0x00000002, 0x0156, 0 },  //  BA: cp d (M:1 T:4 steps:1)
    { 0x00000002, 0x0157, 0 },  //  BB: cp e (M:1 T:4 steps:1)
    { 0x00000002, 0x0158, 0 },  //  BC: cp h (M:1 T:4 steps:1)
    { 0x00000002, 0x0159, 0 },  //  BD: cp l (M:1 T:4 steps:1)
    { 0x00000016, 0x015A, Z80_OPSTATE_FLAGS_INDIRECT },  //  BE: cp (hl) (M:2 T:7 steps:3)
    { 0x00000002, 0x015D, 0 },  //  BF: cp a (M:1 T:4 steps:1)
    { 0x0000016E, 0x015E, 0 },  //  C0: ret nz (M:4 T:11 steps:6)
    { 0x000000B6, 0x0164, 0 },  //  C1: pop bc (M:3 T:10 steps:5)
    { 0x000000B6, 0x0169, 0 },  //  C2: jp nz,nn (M:3 T:10 steps:5)
    { 0x000000B6, 0x016E, 0 },  //  C3: jp nn (M:3 T:10 steps:5)
    { 0x000076B6, 0x0173, 0 },  //  C4: call nz,nn (M:6 T:17 steps:10)
    { 0x000001D8, 0x017D, 0 },  //  C5: push bc (M:3 T:11 steps:5)
    { 0x00000016, 0x0182, Z80_OPSTATE_FLAGS_IMM8 },  //  C6: add n (M:2 T:7 steps:3)
    { 0x000001D8, 0x0185, 0 },  //  C7: rst 0h (M:3 T:11 steps:5)
    { 0x0000016E, 0x018A, 0 },  //  C8: ret z (M:4 T:11 steps:6)
    { 0x000000B6, 0x0190, 0 },  //  C9: ret (M:3 T:10 steps:5)
    { 0x000000B6, 0x0195, 0 },  //  CA: jp z,nn (M:3 T:10 steps:5)
    { 0x00000002, 0x019A, 0 },  //  CB: cb prefix (M:1 T:4 steps:1)
    { 0x000076B6, 0x019B, 0 },  //  CC: call z,nn (M:6 T:17 steps:10)
    { 0x00007636, 0x01A5, 0 },  //  CD: call nn (M:5 T:17 steps:9)
    { 0x00000016, 0x01AE, Z80_OPSTATE_FLAGS_IMM8 },  //  CE: adc n (M:2 T:7 steps:3)
    { 0x000001D8, 0x01B1, 0 },  //  CF: rst 8h (M:3 T:11 steps:5)
    { 0x0000016E, 0x01B6, 0 },  //  D0: ret nc (M:4 T:11 steps:6)
    { 0x000000B6, 0x01BC, 0 },  //  D1: pop de (M:3 T:10 steps:5)
    { 0x000000B6, 0x01C1, 0 },  //  D2: jp nc,nn (M:3 T:10 steps:5)
    { 0x00000166, 0x01C6, 0 },  //  D3: out (n),a (M:3 T:11 steps:5)
    { 0x000076B6, 0x01CB, 0 },  //  D4: call nc,nn (M:6 T:17 steps:10)
    { 0x000001D8, 0x01D5, 0 },  //  D5: push de (M:3 T:11 steps:5)
    { 0x00000016, 0x01DA, Z80_OPSTATE_FLAGS_IMM8 },  //  D6: sub n (M:2 T:7 steps:3)
    { 0x000001D8, 0x01DD, 0 },  //  D7: rst 10h (M:3 T:11 steps:5)
    { 0x0000016E, 0x01E2, 0 },  //  D8: ret c (M:4 T:11 steps:6)
    { 0x00000002, 0x01E8, 0 },  //  D9: exx (M:1 T:4 steps:1)
    { 0x000000B6, 0x01E9, 0 },  //  DA: jp c,nn (M:3 T:10 steps:5)
    { 0x00000166, 0x01EE, 0 },  //  DB: in a,(n) (M:3 T:11 steps:5)
    { 0x000076B6, 0x01F3, 0 },  //  DC: call c,nn (M:6 T:17 steps:10)
    { 0x00000002, 0x01FD, 0 },  //  DD: dd prefix (M:1 T:4 steps:1)
    { 0x00000016, 0x01FE, Z80_OPSTATE_FLAGS_IMM8 },  //  DE: sbc n (M:2 T:7 steps:3)
    { 0x000001D8, 0x0201, 0 },  //  DF: rst 18h (M:3 T:11 steps:5)
    { 0x0000016E, 0x0206, 0 },  //  E0: ret po (M:4 T:11 steps:6)
    { 0x000000B6, 0x020C, 0 },  //  E1: pop hl (M:3 T:10 steps:5)
    { 0x000000B6, 0x0211, 0 },  //  E2: jp po,nn (M:3 T:10 steps:5)
    { 0x00013636, 0x0216, 0 },  //  E3: ex (sp),hl (M:5 T:19 steps:9)
    { 0x000076B6, 0x021F, 0 },  //  E4: call po,nn (M:6 T:17 steps:10)
    { 0x000001D8, 0x0229, 0 },  //  E5: push hl (M:3 T:11 steps:5)
    { 0x00000016, 0x022E, Z80_OPSTATE_FLAGS_IMM8 },  //  E6: and n (M:2 T:7 steps:3)
    { 0x000001D8, 0x0231, 0 },  //  E7: rst 20h (M:3 T:11 steps:5)
    { 0x0000016E, 0x0236, 0 },  //  E8: ret pe (M:4 T:11 steps:6)
    { 0x00000002, 0x023C, 0 },  //  E9: jp hl (M:1 T:4 steps:1)
    { 0x000000B6, 0x023D, 0 },  //  EA: jp pe,nn (M:3 T:10 steps:5)
    { 0x00000002, 0x0242, 0 },  //  EB: ex de,hl (M:1 T:4 steps:1)
    { 0x000076B6, 0x0243, 0 },  //  EC: call pe,nn (M:6 T:17 steps:10)
    { 0x00000002, 0x024D, 0 },  //  ED: ed prefix (M:1 T:4 steps:1)
    { 0x00000016, 0x024E, Z80_OPSTATE_FLAGS_IMM8 },  //  EE: xor n (M:2 T:7 steps:3)
    { 0x000001D8, 0x0251, 0 },  //  EF: rst 28h (M:3 T:11 steps:5)
    { 0x0000016E, 0x0256, 0 },  //  F0: ret p (M:4 T:11 steps:6)
    { 0x000000B6, 0x025C, 0 },  //  F1: pop af (M:3 T:10 steps:5)
    { 0x000000B6, 0x0261, 0 },  //  F2: jp p,nn (M:3 T:10 steps:5)
    { 0x00000002, 0x0266, 0 },  //  F3: di (M:1 T:4 steps:1)
    { 0x000076B6, 0x0267, 0 },  //  F4: call p,nn (M:6 T:17 steps:10)
    { 0x000001D8, 0x0271, 0 },  //  F5: push af (M:3 T:11 steps:5)
    { 0x00000016, 0x0276, Z80_OPSTATE_FLAGS_IMM8 },  //  F6: or n (M:2 T:7 steps:3)
    { 0x000001D8, 0x0279, 0 },  //  F7: rst 30h (M:3 T:11 steps:5)
    { 0x0000016E, 0x027E, 0 },  //  F8: ret m (M:4 T:11 steps:6)
    { 0x0000000A, 0x0284, 0 },  //  F9: ld sp,hl (M:2 T:6 steps:2)
    { 0x000000B6, 0x0286, 0 },  //  FA: jp m,nn (M:3 T:10 steps:5)
    { 0x00000002, 0x028B, 0 },  //  FB: ei (M:1 T:4 steps:1)
    { 0x000076B6, 0x028C, 0 },  //  FC: call m,nn (M:6 T:17 steps:10)
    { 0x00000002, 0x0296, 0 },  //  FD: fd prefix (M:1 T:4 steps:1)
    { 0x00000016, 0x0297, Z80_OPSTATE_FLAGS_IMM8 },  //  FE: cp n (M:2 T:7 steps:3)
    { 0x000001D8, 0x029A, 0 },  //  FF: rst 38h (M:3 T:11 steps:5)
    { 0x00000002, 0x029F, 0 },  // ED 00: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 01: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 02: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 03: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 04: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 05: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 06: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 07: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 08: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 09: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 0A: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 0B: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 0C: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 0D: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 0E: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 0F: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 10: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 11: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 12: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 13: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 14: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 15: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 16: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 17: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 18: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 19: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 1A: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 1B: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 1C: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 1D: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 1E: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 1F: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 20: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 21: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 22: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 23: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 24: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 25: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 26: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 27: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 28: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 29: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 2A: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 2B: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 2C: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 2D: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 2E: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 2F: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 30: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 31: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 32: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 33: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 34: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 35: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 36: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 37: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 38: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 39: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 3A: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 3B: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 3C: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 3D: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 3E: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 3F: ed nop (M:1 T:4 steps:1)
    { 0x0000002C, 0x02A0, 0 },  // ED 40: in b,(c) (M:2 T:8 steps:3)
    { 0x0000002C, 0x02A3, 0 },  // ED 41: out (c),b (M:2 T:8 steps:3)
    { 0x00000102, 0x02A6, 0 },  // ED 42: sbc hl,bc (M:2 T:11 steps:2)
    ...
    { 0x00000102, 0x02BB, 0 },  // ED 4A: adc hl,bc (M:2 T:11 steps:2)
    ...
    { 0x00000102, 0x02CF, 0 },  // ED 52: sbc hl,de (M:2 T:11 steps:2)
    ...
    { 0x00000102, 0x02E2, 0 },  // ED 5A: adc hl,de (M:2 T:11 steps:2)
    ...
    { 0x00000102, 0x02F5, 0 },  // ED 62: sbc hl,hl (M:2 T:11 steps:2)
    ...
    { 0x00000102, 0x030D, 0 },  // ED 6A: adc hl,hl (M:2 T:11 steps:2)
    ...
    { 0x00000102, 0x0325, 0 },  // ED 72: sbc hl,sp (M:2 T:11 steps:2)
    ...
    { 0x00000102, 0x0337, 0 },  // ED 7A: adc hl,sp (M:2 T:11 steps:2)
    ...
    { 0x00000002, 0x029F, 0 },  // ED 82: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 83: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 84: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 85: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 86: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 87: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 88: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 89: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 8A: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 8B: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 8C: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 8D: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 8E: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 8F: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 90: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 91: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 92: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 93: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 94: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 95: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 96: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 97: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 98: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 99: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 9A: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 9B: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 9C: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 9D: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 9E: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED 9F: ed nop (M:1 T:4 steps:1)
    { 0x000002E6, 0x0343, 0 },  // ED A0: ldi (M:4 T:12 steps:6)
    { 0x00000216, 0x0349, 0 },  // ED A1: cpi (M:3 T:12 steps:4)
    { 0x00000398, 0x034D, 0 },  // ED A2: ini (M:3 T:12 steps:5)
    { 0x000002CC, 0x0352, 0 },  // ED A3: outi (M:3 T:12 steps:5)
    { 0x00000002, 0x029F, 0 },  // ED A4: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED A5: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED A6: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED A7: ed nop (M:1 T:4 steps:1)
    { 0x000002E6, 0x0357, 0 },  // ED A8: ldd (M:4 T:12 steps:6)
    { 0x00000216, 0x035D, 0 },  // ED A9: cpd (M:3 T:12 steps:4)
    { 0x00000398, 0x0361, 0 },  // ED AA: ind (M:3 T:12 steps:5)
    { 0x000002CC, 0x0366, 0 },  // ED AB: outd (M:3 T:12 steps:5)
    { 0x00000002, 0x029F, 0 },  // ED AC: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED AD: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED AE: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED AF: ed nop (M:1 T:4 steps:1)
    { 0x000042E6, 0x036B, 0 },  // ED B0: ldir (M:5 T:17 steps:7)
    { 0x00004216, 0x0372, 0 },  // ED B1: cpir (M:4 T:17 steps:5)
    { 0x00004398, 0x0377, 0 },  // ED B2: inir (M:4 T:17 steps:6)
    { 0x000042CC, 0x037D, 0 },  // ED B3: otir (M:4 T:17 steps:6)
    { 0x00000002, 0x029F, 0 },  // ED B4: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED B5: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED B6: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED B7: ed nop (M:1 T:4 steps:1)
    { 0x000042E6, 0x0383, 0 },  // ED B8: lddr (M:5 T:17 steps:7)
    { 0x00004216, 0x038A, 0 },  // ED B9: cpdr (M:4 T:17 steps:5)
    { 0x00004398, 0x038F, 0 },  // ED BA: indr (M:4 T:17 steps:6)
    { 0x000042CC, 0x0395, 0 },  // ED BB: otdr (M:4 T:17 steps:6)
    { 0x00000002, 0x029F, 0 },  // ED BC: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED BD: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED BE: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED BF: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED C0: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED C1: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED C2: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED C3: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED C4: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED C5: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED C6: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED C7: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED C8: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED C9: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED CA: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED CB: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED CC: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED CD: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED CE: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED CF: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED D0: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED D1: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED D2: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED D3: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED D4: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED D5: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED D6: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED D7: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED D8: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED D9: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED DA: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED DB: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED DC: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED DD: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED DE: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED DF: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED E0: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED E1: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED E2: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED E3: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED E4: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED E5: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED E6: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED E7: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED E8: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED E9: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED EA: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED EB: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED EC: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED ED: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED EE: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED EF: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED F0: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED F1: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED F2: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED F3: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED F4: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED F5: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED F6: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED F7: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED F8: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED F9: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED FA: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED FB: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED FC: ed nop (M:1 T:4 steps:1)
    { 0x00000002, 0x029F, 0 },  // ED FD: ed nop (M:1 T:4 steps:1)
...
uint64_t z80_tick(z80_t* cpu, uint64_t pins) {
    ...
    if (cpu->op.pip & 1) {
        switch (cpu->op.step) {
            ...
            // -- OVERLAP
            case 0x02B5: cpu->i=cpu->a;_fetch(); break;
            
            // ED 48: in c,(c) (M:2 T:8)
            // -- M2 (ioread)
            case 0x02B6: _wait();_ioread(cpu->bc); break;
            case 0x02B7: cpu->dlatch=_gd();cpu->wz=cpu->bc+1; break;
            // -- OVERLAP
            case 0x02B8: cpu->c=z80_in(cpu,cpu->dlatch);_fetch(); break;
            
            // ED 49: out (c),c (M:2 T:8)
            // -- M2 (iowrite)
            case 0x02B9: _iowrite(cpu->bc,cpu->c); break;
            case 0x02BA: _wait();cpu->wz=cpu->bc+1; break;
            // -- OVERLAP
            case 0x02BB: _fetch(); break;
            
            // ED 4A: adc hl,bc (M:2 T:11)
            // -- M2 (generic)
            case 0x02BC: z80_adc16(cpu,cpu->bc); break;
            // -- OVERLAP
            ...
            case 0x02BF: cpu->wzl=_gd(); break;
            // -- M3
            case 0x02C0: _wait();_mread(cpu->pc++); break;
            case 0x02C1: cpu->wzh=_gd(); break;
            // -- M4
            case 0x02C2: _wait();_mread(cpu->wz++); break;
            case 0x02C3: cpu->c=_gd(); break;
            // -- M5
            case 0x02C4: _wait();_mread(cpu->wz); break;
            case 0x02C5: cpu->b=_gd(); break;
            // -- OVERLAP
            ...
            // -- OVERLAP
            case 0x02C9: cpu->r=cpu->a;_fetch(); break;
            
            // ED 50: in d,(c) (M:2 T:8)
            // -- M2 (ioread)
            case 0x02CA: _wait();_ioread(cpu->bc); break;
            case 0x02CB: cpu->dlatch=_gd();cpu->wz=cpu->bc+1; break;
            // -- OVERLAP
            case 0x02CC: cpu->d=z80_in(cpu,cpu->dlatch);_fetch(); break;
            
            // ED 51: out (c),d (M:2 T:8)
            // -- M2 (iowrite)
            case 0x02CD: _iowrite(cpu->bc,cpu->d); break;
            case 0x02CE: _wait();cpu->wz=cpu->bc+1; break;
            // -- OVERLAP
            case 0x02CF: _fetch(); break;
            
            // ED 52: sbc hl,de (M:2 T:11)
            // -- M2 (generic)
            case 0x02D0: z80_sbc16(cpu,cpu->de); break;
            // -- OVERLAP
            ...
            case 0x02D3: cpu->wzl=_gd(); break;
            // -- M3
            case 0x02D4: _wait();_mread(cpu->pc++); break;
            case 0x02D5: cpu->wzh=_gd(); break;
            // -- M4
            case 0x02D6: _mwrite(cpu->wz++,cpu->e); break;
            case 0x02D7: _wait(); break;
            // -- M5
            case 0x02D8: _mwrite(cpu->wz,cpu->d); break;
            case 0x02D9: _wait(); break;
            // -- OVERLAP
            ...
            // -- OVERLAP
            case 0x02DC: cpu->a=cpu->i;cpu->f=z80_sziff2_flags(cpu, cpu->i);_fetch(); break;
            
            // ED 58: in e,(c) (M:2 T:8)
            // -- M2 (ioread)
            case 0x02DD: _wait();_ioread(cpu->bc); break;
            case 0x02DE: cpu->dlatch=_gd();cpu->wz=cpu->bc+1; break;
            // -- OVERLAP
            case 0x02DF: cpu->e=z80_in(cpu,cpu->dlatch);_fetch(); break;
            
            // ED 59: out (c),e (M:2 T:8)
            // -- M2 (iowrite)
            case 0x02E0: _iowrite(cpu->bc,cpu->e); break;
            case 0x02E1: _wait();cpu->wz=cpu->bc+1; break;
            // -- OVERLAP
            case 0x02E2: _fetch(); break;
            
            // ED 5A: adc hl,de (M:2 T:11)
            // -- M2 (generic)
            case 0x02E3: z80_adc16(cpu,cpu->de); break;
            // -- OVERLAP
            ...
            case 0x02E6: cpu->wzl=_gd(); break;
            // -- M3
            case 0x02E7: _wait();_mread(cpu->pc++); break;
            case 0x02E8: cpu->wzh=_gd(); break;
            // -- M4
            case 0x02E9: _wait();_mread(cpu->wz++); break;
            case 0x02EA: cpu->e=_gd(); break;
            // -- M5
            case 0x02EB: _wait();_mread(cpu->wz); break;
            case 0x02EC: cpu->d=_gd(); break;
            // -- OVERLAP
            ...
            // -- OVERLAP
            case 0x02EF: cpu->a=cpu->r;cpu->f=z80_sziff2_flags(cpu, cpu->r);_fetch(); break;
            
            // ED 60: in h,(c) (M:2 T:8)
            // -- M2 (ioread)
            case 0x02F0: _wait();_ioread(cpu->bc); break;
            case 0x02F1: cpu->dlatch=_gd();cpu->wz=cpu->bc+1; break;
            // -- OVERLAP
            case 0x02F2: cpu->hlx[cpu->hlx_idx].h=z80_in(cpu,cpu->dlatch);_fetch(); break;
            
            // ED 61: out (c),h (M:2 T:8)
            // -- M2 (iowrite)
            case 0x02F3: _iowrite(cpu->bc,cpu->hlx[cpu->hlx_idx].h); break;
            case 0x02F4: _wait();cpu->wz=cpu->bc+1; break;
            // -- OVERLAP
            case 0x02F5: _fetch(); break;
            
            // ED 62: sbc hl,hl (M:2 T:11)
            // -- M2 (generic)
            case 0x02F6: z80_sbc16(cpu,cpu->hl); break;
            // -- OVERLAP
            ...
            // -- M4
            case 0x02FC: _mwrite(cpu->wz++,cpu->l); break;
            case 0x02FD: _wait(); break;
            // -- M5
            case 0x02FE: _mwrite(cpu->wz,cpu->h); break;
            ...
            // ED 67: rrd (M:4 T:14)
            // -- M2
            case 0x0302: _wait();_mread(cpu->hl); break;
            case 0x0303: cpu->dlatch=_gd(); break;
            // -- M3 (generic)
            case 0x0304: cpu->dlatch=z80_rrd(cpu,cpu->dlatch); break;
            // -- M4
            case 0x0305: _mwrite(cpu->hl,cpu->dlatch); break;
            case 0x0306: _wait();cpu->wz=cpu->hl+1; break;
            // -- OVERLAP
            case 0x0307: _fetch(); break;
            
            // ED 68: in l,(c) (M:2 T:8)
            // -- M2 (ioread)
            case 0x0308: _wait();_ioread(cpu->bc); break;
            case 0x0309: cpu->dlatch=_gd();cpu->wz=cpu->bc+1; break;
            // -- OVERLAP
            case 0x030A: cpu->hlx[cpu->hlx_idx].l=z80_in(cpu,cpu->dlatch);_fetch(); break;
            
            // ED 69: out (c),l (M:2 T:8)
            // -- M2 (iowrite)
            case 0x030B: _iowrite(cpu->bc,cpu->hlx[cpu->hlx_idx].l); break;
            case 0x030C: _wait();cpu->wz=cpu->bc+1; break;
            // -- OVERLAP
            case 0x030D: _fetch(); break;
            
            // ED 6A: adc hl,hl (M:2 T:11)
            // -- M2 (generic)
            case 0x030E: z80_adc16(cpu,cpu->hl); break;
            // -- OVERLAP
            case 0x030F: _fetch(); break;
            
            // ED 6B: ld hl,(nn) (M:5 T:16)
            // -- M2
            case 0x0310: _wait();_mread(cpu->pc++); break;
            case 0x0311: cpu->wzl=_gd(); break;
            // -- M3
            case 0x0312: _wait();_mread(cpu->pc++); break;
            case 0x0313: cpu->wzh=_gd(); break;
            // -- M4
            case 0x0314: _wait();_mread(cpu->wz++); break;
            case 0x0315: cpu->l=_gd(); break;
            // -- M5
            case 0x0316: _wait();_mread(cpu->wz); break;
            case 0x0317: cpu->h=_gd(); break;
            // -- OVERLAP
            ...
            // ED 6F: rld (M:4 T:14)
            // -- M2
            case 0x031A: _wait();_mread(cpu->hl); break;
            case 0x031B: cpu->dlatch=_gd(); break;
            // -- M3 (generic)
            case 0x031C: cpu->dlatch=z80_rld(cpu,cpu->dlatch); break;
            // -- M4
            case 0x031D: _mwrite(cpu->hl,cpu->dlatch); break;
            case 0x031E: _wait();cpu->wz=cpu->hl+1; break;
            // -- OVERLAP
            case 0x031F: _fetch(); break;
            
            // ED 70: in (c) (M:2 T:8)
            // -- M2 (ioread)
            case 0x0320: _wait();_ioread(cpu->bc); break;
            case 0x0321: cpu->dlatch=_gd();cpu->wz=cpu->bc+1; break;
            // -- OVERLAP
            case 0x0322: z80_in(cpu,cpu->dlatch);_fetch(); break;
            
            // ED 71: out (c),0 (M:2 T:8)
            // -- M2 (iowrite)
            case 0x0323: _iowrite(cpu->bc,0); break;
            case 0x0324: _wait();cpu->wz=cpu->bc+1; break;
            // -- OVERLAP
            case 0x0325: _fetch(); break;
            
            // ED 72: sbc hl,sp (M:2 T:11)
            // -- M2 (generic)
            case 0x0326: z80_sbc16(cpu,cpu->sp); break;
            // -- OVERLAP
            case 0x0327: _fetch(); break;
            
            // ED 73: ld (nn),sp (M:5 T:16)
            // -- M2
            case 0x0328: _wait();_mread(cpu->pc++); break;
            case 0x0329: cpu->wzl=_gd(); break;
            // -- M3
            case 0x032A: _wait();_mread(cpu->pc++); break;
            case 0x032B: cpu->wzh=_gd(); break;
            // -- M4
            case 0x032C: _mwrite(cpu->wz++,cpu->spl); break;
            case 0x032D: _wait(); break;
            // -- M5
            case 0x032E: _mwrite(cpu->wz,cpu->sph); break;
            ...
            // -- M2 (ioread)
            case 0x0332: _wait();_ioread(cpu->bc); break;
            case 0x0333: cpu->dlatch=_gd();cpu->wz=cpu->bc+1; break;
            // -- OVERLAP
            case 0x0334: cpu->a=z80_in(cpu,cpu->dlatch);_fetch(); break;
            
            // ED 79: out (c),a (M:2 T:8)
            // -- M2 (iowrite)
            case 0x0335: _iowrite(cpu->bc,cpu->a); break;
            case 0x0336: _wait();cpu->wz=cpu->bc+1; break;
            // -- OVERLAP
            case 0x0337: _fetch(); break;
            
            // ED 7A: adc hl,sp (M:2 T:11)
            // -- M2 (generic)
            case 0x0338: z80_adc16(cpu,cpu->sp); break;
            // -- OVERLAP
            ...
            case 0x033B: cpu->wzl=_gd(); break;
            // -- M3
            case 0x033C: _wait();_mread(cpu->pc++); break;
            case 0x033D: cpu->wzh=_gd(); break;
            // -- M4
            case 0x033E: _wait();_mread(cpu->wz++); break;
            case 0x033F: cpu->spl=_gd(); break;
            // -- M5
            case 0x0340: _wait();_mread(cpu->wz); break;
            case 0x0341: cpu->sph=_gd(); break;
            // -- OVERLAP
            ...
            // -- M4 (generic)
            case 0x0348: z80_ldi_ldd(cpu,cpu->dlatch); break;
            // -- OVERLAP
            ...
            // -- M3 (generic)
            case 0x034C: cpu->wz++;z80_cpi_cpd(cpu,cpu->dlatch); break;
            // -- OVERLAP
            case 0x034D: _fetch(); break;
            
            // ED A2: ini (M:3 T:12)
            // -- M2 (ioread)
            case 0x034E: _wait();_ioread(cpu->bc); break;
            case 0x034F: cpu->dlatch=_gd();cpu->wz=cpu->bc+1;cpu->b--;; break;
            // -- M3
            case 0x0350: _mwrite(cpu->hl++,cpu->dlatch); break;
            case 0x0351: _wait();z80_ini_ind(cpu,cpu->dlatch,cpu->c+1); break;
            // -- OVERLAP
            case 0x0352: _fetch(); break;
            
            // ED A3: outi (M:3 T:12)
            // -- M2
            case 0x0353: _wait();_mread(cpu->hl++); break;
            case 0x0354: cpu->dlatch=_gd();cpu->b--; break;
            // -- M3 (iowrite)
            case 0x0355: _iowrite(cpu->bc,cpu->dlatch); break;
            case 0x0356: _wait();cpu->wz=cpu->bc+1;z80_outi_outd(cpu,cpu->dlatch); break;
            // -- OVERLAP
            case 0x0357: _fetch(); break;
            
            // ED A8: ldd (M:4 T:12)
            // -- M2
            case 0x0358: _wait();_mread(cpu->hl--); break;
            case 0x0359: cpu->dlatch=_gd(); break;
            // -- M3
            case 0x035A: _mwrite(cpu->de--,cpu->dlatch); break;
            case 0x035B: _wait(); break;
            // -- M4 (generic)
            case 0x035C: z80_ldi_ldd(cpu,cpu->dlatch); break;
            // -- OVERLAP
            ...
            // -- M3 (generic)
            case 0x0360: cpu->wz--;z80_cpi_cpd(cpu,cpu->dlatch); break;
            // -- OVERLAP
            case 0x0361: _fetch(); break;
            
            // ED AA: ind (M:3 T:12)
            // -- M2 (ioread)
            case 0x0362: _wait();_ioread(cpu->bc); break;
            case 0x0363: cpu->dlatch=_gd();cpu->wz=cpu->bc-1;cpu->b--;; break;
            // -- M3
            case 0x0364: _mwrite(cpu->hl--,cpu->dlatch); break;
            case 0x0365: _wait();z80_ini_ind(cpu,cpu->dlatch,cpu->c-1); break;
            // -- OVERLAP
            case 0x0366: _fetch(); break;
            
            // ED AB: outd (M:3 T:12)
            // -- M2
            case 0x0367: _wait();_mread(cpu->hl--); break;
            case 0x0368: cpu->dlatch=_gd();cpu->b--; break;
            // -- M3 (iowrite)
            case 0x0369: _iowrite(cpu->bc,cpu->dlatch); break;
            case 0x036A: _wait();cpu->wz=cpu->bc-1;z80_outi_outd(cpu,cpu->dlatch); break;
            // -- OVERLAP
            case 0x036B: _fetch(); break;
            
            // ED B0: ldir (M:5 T:17)
            // -- M2
            case 0x036C: _wait();_mread(cpu->hl++); break;
            case 0x036D: cpu->dlatch=_gd(); break;
            // -- M3
            case 0x036E: _mwrite(cpu->de++,cpu->dlatch); break;
            case 0x036F: _wait(); break;
            // -- M4 (generic)
            case 0x0370: if(!z80_ldi_ldd(cpu,cpu->dlatch)){z80_skip(cpu,1,7,2);}; break;
            // -- M5 (generic)
            case 0x0371: cpu->wz=--cpu->pc;--cpu->pc;; break;
            // -- OVERLAP
            case 0x0372: _fetch(); break;
            
            // ED B1: cpir (M:4 T:17)
            // -- M2
            case 0x0373: _wait();_mread(cpu->hl++); break;
            case 0x0374: cpu->dlatch=_gd(); break;
            // -- M3 (generic)
            case 0x0375: cpu->wz++;if(!z80_cpi_cpd(cpu,cpu->dlatch)){z80_skip(cpu,1,7,2);}; break;
            // -- M4 (generic)
            case 0x0376: cpu->wz=--cpu->pc;--cpu->pc; break;
            // -- OVERLAP
            case 0x0377: _fetch(); break;
            
            // ED B2: inir (M:4 T:17)
            // -- M2 (ioread)
            case 0x0378: _wait();_ioread(cpu->bc); break;
            case 0x0379: cpu->dlatch=_gd();cpu->wz=cpu->bc+1;cpu->b--;; break;
            // -- M3
            case 0x037A: _mwrite(cpu->hl++,cpu->dlatch); break;
            case 0x037B: _wait();if (!z80_ini_ind(cpu,cpu->dlatch,cpu->c+1)){z80_skip(cpu,1,6,1);}; break;
            // -- M4 (generic)
            case 0x037C: cpu->wz=--cpu->pc;--cpu->pc; break;
            // -- OVERLAP
            case 0x037D: _fetch(); break;
            
            // ED B3: otir (M:4 T:17)
            // -- M2
            case 0x037E: _wait();_mread(cpu->hl++); break;
            case 0x037F: cpu->dlatch=_gd();cpu->b--; break;
            // -- M3 (iowrite)
            case 0x0380: _iowrite(cpu->bc,cpu->dlatch); break;
            case 0x0381: _wait();cpu->wz=cpu->bc+1;if(!z80_outi_outd(cpu,cpu->dlatch)){z80_skip(cpu,1,6,1);}; break;
            // -- M4 (generic)
            case 0x0382: cpu->wz=--cpu->pc;--cpu->pc; break;
            // -- OVERLAP
            case 0x0383: _fetch(); break;
            
            // ED B8: lddr (M:5 T:17)
            // -- M2
            case 0x0384: _wait();_mread(cpu->hl--); break;
            case 0x0385: cpu->dlatch=_gd(); break;
            // -- M3
            case 0x0386: _mwrite(cpu->de--,cpu->dlatch); break;
            case 0x0387: _wait(); break;
            // -- M4 (generic)
            case 0x0388: if(!z80_ldi_ldd(cpu,cpu->dlatch)){z80_skip(cpu,1,7,2);}; break;
            // -- M5 (generic)
            case 0x0389: cpu->wz=--cpu->pc;--cpu->pc;; break;
            // -- OVERLAP
            case 0x038A: _fetch(); break;
            
            // ED B9: cpdr (M:4 T:17)
            // -- M2
            case 0x038B: _wait();_mread(cpu->hl--); break;
            case 0x038C: cpu->dlatch=_gd(); break;
            // -- M3 (generic)
            case 0x038D: cpu->wz--;if(!z80_cpi_cpd(cpu,cpu->dlatch)){z80_skip(cpu,1,7,2);}; break;
            // -- M4 (generic)
            case 0x038E: cpu->wz=--cpu->pc;--cpu->pc; break;
            // -- OVERLAP
            case 0x038F: _fetch(); break;
            
            // ED BA: indr (M:4 T:17)
            // -- M2 (ioread)
            case 0x0390: _wait();_ioread(cpu->bc); break;
            case 0x0391: cpu->dlatch=_gd();cpu->wz=cpu->bc-1;cpu->b--;; break;
            // -- M3
            case 0x0392: _mwrite(cpu->hl--,cpu->dlatch); break;
            case 0x0393: _wait();if (!z80_ini_ind(cpu,cpu->dlatch,cpu->c-1)){z80_skip(cpu,1,6,1);}; break;
            // -- M4 (generic)
            case 0x0394: cpu->wz=--cpu->pc;--cpu->pc; break;
            // -- OVERLAP
            case 0x0395: _fetch(); break;
            
            // ED BB: otdr (M:4 T:17)
            // -- M2
            case 0x0396: _wait();_mread(cpu->hl--); break;
            case 0x0397: cpu->dlatch=_gd();cpu->b--; break;
            // -- M3 (iowrite)
            case 0x0398: _iowrite(cpu->bc,cpu->dlatch); break;
            case 0x0399: _wait();cpu->wz=cpu->bc-1;if(!z80_outi_outd(cpu,cpu->dlatch)){z80_skip(cpu,1,6,1);}; break;
            // -- M4 (generic)
            case 0x039A: cpu->wz=--cpu->pc;--cpu->pc; break;
            // -- OVERLAP
            ...
            case 0x039E: cpu->dlatch=_gd();if(!z80_cb_action(cpu,6,6)){z80_skip(cpu,2,6,3);}; break;
            // -- M3
            ...
            // -- M3
            case 0x03A4: _wait();_mread(cpu->pc++); break;
            case 0x03A5: cpu->dlatch=_gd();z80_ddfdcb_opcode(cpu,cpu->dlatch); break;
            // -- M4
            case 0x03A6: _wait();_mread(cpu->addr); break;
            case 0x03A7: cpu->dlatch=_gd();if(!z80_cb_action(cpu,6,cpu->opcode&7)){z80_skip(cpu,2,6,3);}; break;
            // -- M5
